...
tellraw @s {"text":"  •  獲得整套無防護的盔甲","click_event":{"action":"run_command","command":"/function wma:dummy/sys/zero_armor_items"},"hover_event":{"action":"show_text","value":["用來測試附魔之類的東西(. ❛ ᴗ ❛.)"]}}
tellraw @s ["",{"text":"     ◦  [頭盔]","click_event":{"action":"run_command","command":"/function wma:dummy/zero_items/helmet"},"hover_event":{"action":"show_text","value":["點我！"]}},{"text":"  [胸甲]","click_event":{"action":"run_command","command":"/function wma:dummy/zero_items/chestplate"},"hover_event":{"action":"show_text","value":["點我！"]}},{"text":"  [護腿]","click_event":{"action":"run_command","command":"/function wma:dummy/zero_items/leggings"},"hover_event":{"action":"show_text","value":["點我！"]}},{"text":"  [鞋子]","click_event":{"action":"run_command","command":"/function wma:dummy/zero_items/boots"},"hover_event":{"action":"show_text","value":["點我！"]}}]
tellraw @s {"text":"  •  獲得整套無傷害的武器","click_event":{"action":"run_command","command":"/function wma:dummy/sys/zero_weapon_items"},"hover_event":{"action":"show_text","value":["用來測試附魔之類的東西(. ❛ ᴗ ❛.)"]}}
