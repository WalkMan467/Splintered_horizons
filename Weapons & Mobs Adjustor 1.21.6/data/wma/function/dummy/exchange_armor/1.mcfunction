...
$data modify entity @e[type=item,tag=wma.quit_item,limit=1] Item set from entity @s ArmorItems[$(slot)]
...
$data modify entity @s ArmorItems[$(slot)] set from entity @e[type=item,tag=,sort=nearest,limit=1] Item
