...
execute \
    if score @s particle.sound_wave matches 0..6 run \
particle minecraft:note ~ ~ ~ 0.5 0.5 0.5 1 1 normal

execute \
    if score @s particle.sound_wave matches 12 run \
particle minecraft:sonic_boom ~ ~ ~ 0.5 0 0.5 0 1

execute \
    if score @s particle.sound_wave matches 13.. run \
particle minecraft:note ~ ~ ~ 0.5 0.5 0.5 1 1 normal
...
execute \
    if score @s particle.sound_wave matches 42.. run \
