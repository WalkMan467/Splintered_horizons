...
execute if score @s[tag=!monster.elekiel_phase_2.skill.4.portal.target] monster.elekiel_phase_2.skill.4.portal.id = @p[tag=monsters.elekiel_phase_2.portal.tp.player] player.id run tag @s add monster.elekiel_phase_2.skill.4.portal.target
execute as @a[tag=monsters.elekiel_phase_2.portal.tp.player,tag=!monster.elekiel_phase_2.skill.4.portal.target] if score @s player.id = @e[tag=monster.elekiel_phase_2.skill.4.portal.target,limit=1,type=block_display,tag=monsters.elekiel_phase_2.portal.tp] monster.elekiel_phase_2.skill.4.portal.id run tag @s add monster.elekiel_phase_2.skill.4.portal.target

execute as @a[tag=monster.elekiel_phase_2.skill.4.portal.target,tag=monsters.elekiel_phase_2.portal.tp.player] at @s run spectate @e[limit=1,tag=monster.elekiel_phase_2.skill.4.portal.target,type=block_display,tag=monsters.elekiel_phase_2.portal.tp]
