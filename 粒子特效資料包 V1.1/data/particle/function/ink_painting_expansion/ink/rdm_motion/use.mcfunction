...
execute store result storage particle.ink_painting_expansion.ink.rdm_motion temp.x float 0.01 run random value -50..50
execute store result storage particle.ink_painting_expansion.ink.rdm_motion temp.y float 0.01 run random value 25..75
execute store result storage particle.ink_painting_expansion.ink.rdm_motion temp.z float 0.01 run random value -50..50
