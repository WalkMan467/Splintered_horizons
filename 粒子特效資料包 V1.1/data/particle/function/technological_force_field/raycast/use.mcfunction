execute store result score #particle.technological_force_field main.raycast run random value 2..15
...
execute as @n[type=area_effect_cloud,tag=particle.technological_force_field.raycast,tag=summon] at @s run function particle:technological_force_field/raycast/detect
