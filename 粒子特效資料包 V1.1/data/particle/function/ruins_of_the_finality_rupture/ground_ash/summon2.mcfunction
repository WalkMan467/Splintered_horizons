...
tp @n[distance=0..,tag=summon,sort=arbitrary,limit=1,tag=!aj.display,type=text_display] ~ ~ ~ ~ ~
...
tag @e[tag=summon,sort=arbitrary,limit=2,tag=!aj.display,distance=0..,type=text_display] remove summon
