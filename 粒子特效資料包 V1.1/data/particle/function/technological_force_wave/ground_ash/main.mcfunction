...
execute \
    if score @s particle.technological_force_wave matches ..10 run \
tp @s ^ ^ ^1
...
execute \
    if score @s particle.technological_force_wave matches 15.. run \
function particle:technological_force_wave/ground_ash/end