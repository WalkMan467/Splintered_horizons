...
function particle:radial_exoansion/ground_ash/deformation/1

execute \
    if score @s particle.sound_wave matches 10 run \
function particle:radial_exoansion/ground_ash/deformation/2
...
function particle:radial_exoansion/ground_ash/end