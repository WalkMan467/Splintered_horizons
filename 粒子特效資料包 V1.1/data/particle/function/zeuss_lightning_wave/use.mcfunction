...
scoreboard players set @n[tag=particle.zeuss_lightning.lightning.end,tag=summon,type=item_display,distance=..5] duration 12
tag @n[tag=particle.zeuss_lightning.lightning.end,tag=summon,type=item_display,distance=..5] remove summon
