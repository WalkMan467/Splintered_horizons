...
$execute \
    ...
    positioned $(x) $(y) $(z) run function spawner_tweaker:spawner_priming/prime with storage spawner_tweaker:temp Priming[$(n)]
$execute \
...
#Looping
$execute \
    if score n temp < $modification_limit spawner_tweaker run function spawner_tweaker:spawner_priming/attempt_prime with storage spawner_tweaker:temp Priming[$(next)]