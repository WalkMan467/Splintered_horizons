...
execute \
    if score spawners_primed st_priming >= total_spawners st_priming run function spawner_tweaker:spawner_priming/end
...
execute \
    if score timer st_priming >= max temp run function spawner_tweaker:spawner_priming/end