...
execute \
    if score $st_ongoing_process temp matches 1.. run scoreboard players set @s prime_spawners -999
...
execute \
    if score delay st_priming matches ..0 run scoreboard players set delay st_priming 0
