...
$execute \
    if score pass temp matches 3.. run function spawner_tweaker:chests/delete/display with storage spawner_tweaker:temp Chests[$(n)]

#pruning data
$execute \
    if score pass temp matches 3.. run data modify storage spawner_tweaker:temp Chests[$(n)].remove set value 1b
