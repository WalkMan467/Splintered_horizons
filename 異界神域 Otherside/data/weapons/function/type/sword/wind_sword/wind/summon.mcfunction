...
# wind
execute anchored eyes run summon item_display ^ ^ ^ {Tags:[wind_sword.wind,summon],item:{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:custom_model_data":24}},item_display:"head",teleport_duration:1}
