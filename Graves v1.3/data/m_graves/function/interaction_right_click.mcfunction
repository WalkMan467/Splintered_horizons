...
advancement revoke @s only m_graves:right_click_interaction
tag @s add multipack.interactor
execute as @e[distance=..10,type=interaction,tag=multipack.grave] at @s on target if entity @s[tag=multipack.interactor] \
