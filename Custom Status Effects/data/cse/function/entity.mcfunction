...
execute as @s[tag=cse.status_effect.tactical_scroll_of_brilliance.armor_enhancement] at @s run function cse:status_effects/apply/item/tactical_scroll_of_brilliance/armor_enhancement/main
execute as @s[tag=cse.status_effect.tactical_scroll_of_brilliance.strength] at @s run function cse:status_effects/apply/item/tactical_scroll_of_brilliance/strength/main
execute as @s[tag=cse.status_effect.tactical_scroll_of_brilliance.speed] at @s run function cse:status_effects/apply/item/tactical_scroll_of_brilliance/speed/main
