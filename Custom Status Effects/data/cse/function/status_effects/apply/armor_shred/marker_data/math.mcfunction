...
execute store result score #value cse.status_effects.armor_shred.math run \
data get entity @s data.cse.armor_shred.add.value 1000

execute store result score #base cse.status_effects.armor_shred.math run \
data get entity @s data.cse.armor_shred.base_value 1000


execute store result score #max cse.status_effects.armor_shred.math run \
...
execute store result entity @s data.cse.armor_shred.base_value float 0.001 run \
