...
execute \
    ...
    if score @s cse.status_effects.armor_shred.id = @e[type=!marker,tag=cse.status_effect.armor_shred.user,tag=cse.status_effect.armor_shred.data_target,limit=1] cse.status_effects.armor_shred.id run \
tag @s add cse.status_effect.armor_shred.data_target
$execute \
    as @n[type=marker,tag=cse.status_effect.armor_shred.data,tag=cse.status_effect.armor_shred.data_target] run \
function cse:status_effects/apply/armor_shred/marker_data/math {value:$(value), max:$(max)}
