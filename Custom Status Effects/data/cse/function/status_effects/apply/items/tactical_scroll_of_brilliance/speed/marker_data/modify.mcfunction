...
$execute as @n[type=marker,tag=cse.status_effects.tactical_scroll_of_brilliance.speed.data,tag=cse.status_effects.tactical_scroll_of_brilliance.speed.data_target] run function cse:status_effects/apply/items/tactical_scroll_of_brilliance/speed/marker_data/math {value:$(value), max:$(max)}
...
function cse:status_effects/apply/items/tactical_scroll_of_brilliance/speed/marker_data/merge_2 with storage cse:status_effects tactical_scroll_of_brilliance.speed.final_value
