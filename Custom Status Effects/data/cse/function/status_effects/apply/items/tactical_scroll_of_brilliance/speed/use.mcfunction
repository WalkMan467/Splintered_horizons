...
$execute unless entity @s[tag=cse.status_effect.tactical_scroll_of_brilliance.speed] run function cse:status_effects/apply/items/tactical_scroll_of_brilliance/speed/marker_data/add {base:$(base), value:$(value), max:$(max)}
$execute if entity @s[tag=cse.status_effect.tactical_scroll_of_brilliance.speed] run function cse:status_effects/apply/items/tactical_scroll_of_brilliance/speed/marker_data/modify {value:$(value), max:$(max)}
...
tag @s add cse.status_effect.tactical_scroll_of_brilliance.speed
    ...
    # Example:
# function cse:status_effects/apply/items/tactical_scroll_of_brilliance/speed/use {duration:100,base:0.1, value:0.1,max:1.0}