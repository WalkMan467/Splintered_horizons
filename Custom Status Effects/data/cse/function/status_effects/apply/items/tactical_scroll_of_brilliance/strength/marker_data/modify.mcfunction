...
$execute as @n[type=marker,tag=cse.status_effects.tactical_scroll_of_brilliance.strength.data,tag=cse.status_effects.tactical_scroll_of_brilliance.strength.data_target] run function cse:status_effects/apply/items/tactical_scroll_of_brilliance/strength/marker_data/math {value:$(value), max:$(max)}
...
function cse:status_effects/apply/items/tactical_scroll_of_brilliance/strength/marker_data/merge_2 with storage cse:status_effects tactical_scroll_of_brilliance.strength.final_value
