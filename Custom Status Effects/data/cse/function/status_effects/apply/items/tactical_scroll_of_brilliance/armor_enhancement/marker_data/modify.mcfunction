...
function cse:status_effects/apply/items/tactical_scroll_of_brilliance/armor_enhancement/marker_data/merge_2 with storage cse:status_effects tactical_scroll_of_brilliance.armor_enhancement.final_value
