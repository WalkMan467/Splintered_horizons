...
execute \
    store result score #value cse.status_effects.monsters.emissary_of_the_temporal_rift.key.math run \
data get entity @s data.cse.slowness.add.value 1000

execute \
    store result score #base cse.status_effects.monsters.emissary_of_the_temporal_rift.key.math run \
data get entity @s data.cse.slowness.base_value 1000


execute \
    store result score #max cse.status_effects.monsters.emissary_of_the_temporal_rift.key.math run \
...
execute \
    store result entity @s data.cse.slowness.base_value float 0.001 run \
