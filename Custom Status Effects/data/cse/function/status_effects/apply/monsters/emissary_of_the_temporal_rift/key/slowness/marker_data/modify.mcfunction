...
execute \
    as @e[type=marker,tag=cse.status_effects.monsters.emissary_of_the_temporal_rift.key.data] \
...
tag @s add cse.status_effects.monsters.emissary_of_the_temporal_rift.key.data_target
$execute \
    as @n[type=marker,tag=cse.status_effects.monsters.emissary_of_the_temporal_rift.key.data,tag=cse.status_effects.monsters.emissary_of_the_temporal_rift.key.data_target] run \
function cse:status_effects/apply/monsters/emissary_of_the_temporal_rift/key/slowness/marker_data/math {value:$(value), max:$(max)}
