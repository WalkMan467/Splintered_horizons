...
$execute unless entity @s[tag=cse.status_effect.tactical_scroll_of_brilliance.armor_enhancement] run function cse:status_effects/apply/tactical_scroll_of_brilliance/armor_enhancement/marker_data/add {base:$(base), value:$(value), max:$(max)}
$execute if entity @s[tag=cse.status_effect.tactical_scroll_of_brilliance.armor_enhancement] run function cse:status_effects/apply/tactical_scroll_of_brilliance/armor_enhancement/marker_data/modify {value:$(value), max:$(max)}
...
tag @s add cse.status_effect.tactical_scroll_of_brilliance.armor_enhancement
    ...
    # Example:
# function cse:status_effects/apply/tactical_scroll_of_brilliance/armor_enhancement/use {duration:100,base:0.1, value:0.1,max:1.0}