...
$execute unless entity @s[tag=cse.status_effect.tactical_scroll_of_brilliance.speed] run function cse:status_effects/apply/item/tactical_scroll_of_brilliance/speed/marker_data/add {base:$(base), value:$(value), max:$(max)}
$execute if entity @s[tag=cse.status_effect.tactical_scroll_of_brilliance.speed] run function cse:status_effects/apply/item/tactical_scroll_of_brilliance/speed/marker_data/modify {value:$(value), max:$(max)}
