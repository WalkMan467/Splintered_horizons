...
execute \
    as @e[type=marker,tag=cse.status_effects.tactical_scroll_of_brilliance.armor_enhancement.data] \
...
tag @s add cse.status_effects.tactical_scroll_of_brilliance.armor_enhancement.data_target
$execute \
    as @n[type=marker,tag=cse.status_effects.tactical_scroll_of_brilliance.armor_enhancement.data,tag=cse.status_effects.tactical_scroll_of_brilliance.armor_enhancement.data_target] run \
function cse:status_effects/apply/item/tactical_scroll_of_brilliance/armor_enhancement/marker_data/math {value:$(value), max:$(max)}
...
function cse:status_effects/apply/item/tactical_scroll_of_brilliance/armor_enhancement/marker_data/merge_2 with storage cse:status_effects tactical_scroll_of_brilliance.armor_enhancement.final_value
