...
execute \
    as @e[type=marker,tag=cse.status_effects.tactical_scroll_of_brilliance.strength.data] \
    if score @s cse.status_effects.tactical_scroll_of_brilliance.strength.id = @e[type=!marker,tag=cse.status_effects.tactical_scroll_of_brilliance.strength.user,tag=cse.status_effects.tactical_scroll_of_brilliance.strength.data_target,limit=1] cse.status_effects.tactical_scroll_of_brilliance.strength.id run \
tag @s add cse.status_effects.tactical_scroll_of_brilliance.strength.data_target
$execute \
    as @n[type=marker,tag=cse.status_effects.tactical_scroll_of_brilliance.strength.data,tag=cse.status_effects.tactical_scroll_of_brilliance.strength.data_target] run \
function cse:status_effects/apply/item/tactical_scroll_of_brilliance/strength/marker_data/math {value:$(value), max:$(max)}
