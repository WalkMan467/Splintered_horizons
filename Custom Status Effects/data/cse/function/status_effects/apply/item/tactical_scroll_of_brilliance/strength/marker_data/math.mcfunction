...
execute store result score #value cse.status_effects.tactical_scroll_of_brilliance.strength.math run \
data get entity @s data.cse.status_effects.tactical_scroll_of_brilliance.strength.add_value 1000

execute store result score #base cse.status_effects.tactical_scroll_of_brilliance.strength.math run \
data get entity @s data.cse.status_effects.tactical_scroll_of_brilliance.strength.base_value 1000


execute store result score #max cse.status_effects.tactical_scroll_of_brilliance.strength.math run \
...
execute store result entity @s data.cse.status_effects.tactical_scroll_of_brilliance.strength.base_value float 0.001 run \
