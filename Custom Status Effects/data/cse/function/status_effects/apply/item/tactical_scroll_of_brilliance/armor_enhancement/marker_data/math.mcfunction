...
scoreboard players operation #base cse.status_effects.tactical_scroll_of_brilliance.armor_enhancement.math += #value cse.status_effects.tactical_scroll_of_brilliance.armor_enhancement.math
