...
execute \
    ...
    if score @s cse.status_effects.tactical_scroll_of_brilliance.speed.id = @e[type=!marker,tag=cse.status_effects.tactical_scroll_of_brilliance.speed.user,tag=cse.status_effects.tactical_scroll_of_brilliance.speed.data_target.merge,limit=1] cse.status_effects.tactical_scroll_of_brilliance.speed.id run \
tag @s add cse.status_effects.tactical_scroll_of_brilliance.speed.data_target.merge
