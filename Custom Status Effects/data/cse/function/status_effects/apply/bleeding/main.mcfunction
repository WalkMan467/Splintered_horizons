...
execute if score @s cse.status_effects.bleeding matches 0.. if score @s cse.status_effects.bleeding.dot > @s cse.status_effects.bleeding.dot_max run scoreboard players operation @s cse.status_effects.bleeding.dot = @s cse.status_effects.bleeding.dot_max
