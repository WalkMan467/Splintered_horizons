...
execute store result storage cse:status_effects bleeding.dot int 0.1 run scoreboard players get @s cse.status_effects.bleeding.dot
...
scoreboard players operation @s cse.status_effects.bleeding.dot = @s cse.status_effects.bleeding.base_dot
