...
execute \
    store result score #value cse.status_effects.weakness.math run \
data get entity @s data.cse.weakness.add.value 1000

execute \
    store result score #base cse.status_effects.weakness.math run \
data get entity @s data.cse.weakness.base_value 1000


execute \
    store result score #max cse.status_effects.weakness.math run \
...
execute \
    store result entity @s data.cse.weakness.base_value float 0.001 run \
