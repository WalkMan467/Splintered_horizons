...
function animated_java:chain_lock/animations/lock/zzz/apply_frame with storage aj:temp args

execute \
    if score @s aj.lock.frame matches 40.. run return run function animated_java:chain_lock/animations/lock/pause
