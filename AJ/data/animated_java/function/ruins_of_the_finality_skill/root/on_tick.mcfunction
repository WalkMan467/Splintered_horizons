...
execute if entity @s[tag=aj.ruins_of_the_finality_skill.animation.skills_3.playing] run function animated_java:ruins_of_the_finality_skill/animations/skills_3/zzz/on_tick
execute on passengers if entity @s[tag=aj.ruins_of_the_finality_skill.data] run function animated_java:ruins_of_the_finality_skill/root/zzz/on_tick/locators_and_cameras
