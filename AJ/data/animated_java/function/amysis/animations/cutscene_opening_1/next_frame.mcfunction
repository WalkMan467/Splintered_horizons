...
execute \
    unless entity @s[type=minecraft:item_display,tag=aj.amysis.root] run return run function animated_java:global/errors/function_not_executed_as_root_entity {'export_namespace': 'amysis', 'function_path': 'animated_java:amysis/animations/cutscene_opening_1/next_frame'}
