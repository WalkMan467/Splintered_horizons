...
execute if score @s aj.cutscene_chapter_2_safe_zone_1.frame matches -1 run function animated_java:amysis/animations/cutscene_chapter_2_safe_zone_1/zzz/commands_keyframe_loop_patch
