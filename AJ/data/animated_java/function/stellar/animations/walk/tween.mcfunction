...
tag @s add animated_java.stellar.animation.walk.playing
...
execute at @s run function animated_java:stellar/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:stellar/animations/walk/zzz/apply_frame {frame: $(to_frame)}
