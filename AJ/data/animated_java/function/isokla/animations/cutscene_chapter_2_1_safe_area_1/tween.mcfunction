...
tag @s add animated_java.isokla.animation.cutscene_chapter_2_1_safe_area_1.playing
...
execute at @s run function animated_java:isokla/animations/cutscene_chapter_2_1_safe_area_1/zzz/apply_frame {frame: 0}
