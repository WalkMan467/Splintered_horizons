...
execute \
    if data storage animated_java:temp {args:{start_animation: true}} run function animated_java:boss_1/zzz/summon/animation_arg/start_animation with storage animated_java:temp args
