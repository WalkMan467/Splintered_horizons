...
tag @s add animated_java.boss_1.animation.idle.playing
...
execute at @s run function animated_java:boss_1/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:boss_1/animations/idle/zzz/apply_frame {frame: $(to_frame)}
