...
execute \
    store result storage aj:temp args.x int 1 \
    store result score #this.x aj.i run data get entity @s Pos[0] 1

execute \
    store result storage aj:temp args.y int 1 \
    store result score #this.y aj.i run data get entity @s Pos[1] 1

execute \
    store result storage aj:temp args.z int 1 \
    store result score #this.z aj.i run data get entity @s Pos[2] 1
function animated_java:screen_sneak/root/zzz/show_outdated_warning with storage aj:temp args
data modify entity @s data.rigHash set value '3bdae359b8d0d25d7d5f941c30d0cbe8336d4c154cbbc51813381f688989eec9'
