...
execute \
    unless entity @s[type=minecraft:item_display,tag=aj.screen_sneak.root] run return run function animated_java:global/errors/function_not_executed_as_root_entity {'export_namespace': 'screen_sneak', 'function_path': 'animated_java:screen_sneak/animations/screen_sneak/next_frame'}
