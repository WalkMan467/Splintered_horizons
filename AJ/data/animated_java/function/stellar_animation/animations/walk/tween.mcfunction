...
execute at @s run function animated_java:stellar_animation/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:stellar_animation/animations/walk/zzz/apply_frame {frame: $(to_frame)}
