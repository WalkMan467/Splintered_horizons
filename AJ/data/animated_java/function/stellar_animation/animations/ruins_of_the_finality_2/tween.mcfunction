...
tag @s add aj.stellar_animation.animation.ruins_of_the_finality_2.playing
$scoreboard players set @s aj.tween_duration $(duration)
$scoreboard players set @s aj.ruins_of_the_finality_2.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only

execute at @s run function animated_java:stellar_animation/animations/ruins_of_the_finality_2/zzz/apply_frame {frame: 0}
