...
execute as @n[ type=minecraft:item_display, tag=aj.stellar_animation.camera.camera3, tag=aj.new, distance=..3 ] run function animated_java:stellar_animation/zzz/summon/as_data_entity/as_camera/camera3
data modify entity @s data.uuids append from storage animated_java:gu out
