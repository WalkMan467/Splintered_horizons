...
execute \
    if data storage aj:temp {args:{start_animation: true}} run function animated_java:yibb_tstll/zzz/summon/animation_arg/start_animation with storage aj:temp args