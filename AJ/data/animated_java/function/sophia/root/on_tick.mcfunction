...
execute unless entity @s[tag=aj.sophia.root] run return 0
execute if entity @s[tag=aj.sophia.animation.idle.playing] run function animated_java:sophia/animations/idle/zzz/on_tick
execute if entity @s[tag=aj.sophia.animation.idle2.playing] run function animated_java:sophia/animations/idle2/zzz/on_tick
