...
execute \
    unless entity @s[type=minecraft:item_display,tag=aj.portal.root] run return run function animated_java:global/errors/function_not_executed_as_root_entity {'export_namespace': 'portal', 'function_path': 'animated_java:portal/animations/idle/next_frame'}
