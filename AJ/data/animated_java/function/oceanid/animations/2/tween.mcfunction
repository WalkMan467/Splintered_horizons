...
execute unless entity @s[type=minecraft:item_display,tag=aj.oceanid.root] run return run function animated_java:global/errors/function_not_executed_as_root_entity {'export_namespace': 'oceanid', 'function_path': 'animated_java:oceanid/animations/2/tween'}
...
$scoreboard players set @s aj.2.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function animated_java:oceanid/animations/2/zzz/apply_frame {frame: 0}
