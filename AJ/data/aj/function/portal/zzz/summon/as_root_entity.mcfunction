...
execute on passengers if entity @s[tag=aj.portal.node.block_display1] run function aj:portal/zzz/summon/as_node/block_display1
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.block_display1 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.block_display2] run function aj:portal/zzz/summon/as_node/block_display2
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.block_display2 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.block_display3] run function aj:portal/zzz/summon/as_node/block_display3
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.block_display3 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.block_display4] run function aj:portal/zzz/summon/as_node/block_display4
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.block_display4 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.block_display5] run function aj:portal/zzz/summon/as_node/block_display5
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.block_display5 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.bone1] run function aj:portal/zzz/summon/as_node/bone1
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.bone1 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.item_display] run function aj:portal/zzz/summon/as_node/item_display
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.item_display set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.item_display1] run function aj:portal/zzz/summon/as_node/item_display1
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.item_display1 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.item_display2] run function aj:portal/zzz/summon/as_node/item_display2
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.item_display2 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.item_display3] run function aj:portal/zzz/summon/as_node/item_display3
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.item_display3 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.item_display4] run function aj:portal/zzz/summon/as_node/item_display4
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.item_display4 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.item_display5] run function aj:portal/zzz/summon/as_node/item_display5
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.item_display5 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.item_display6] run function aj:portal/zzz/summon/as_node/item_display6
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.item_display6 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.item_display7] run function aj:portal/zzz/summon/as_node/item_display7
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.item_display7 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.item_display8] run function aj:portal/zzz/summon/as_node/item_display8
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.item_display8 set from storage animated_java:gu out
execute on passengers if entity @s[tag=aj.portal.node.item_display9] run function aj:portal/zzz/summon/as_node/item_display9
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
...
execute at @s run function aj:portal/zzz/summon/on_summon/rig
tag @s remove aj.new
