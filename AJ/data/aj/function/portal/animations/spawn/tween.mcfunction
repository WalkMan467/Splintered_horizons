...
function aj:portal/animations/pause_all
...
execute at @s run function aj:portal/animations/spawn/zzz/apply_frame {frame: 0}
$execute at @s run function aj:portal/animations/spawn/zzz/apply_frame {frame: $(to_frame)}
