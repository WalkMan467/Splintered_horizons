...
execute at @s run function aj:aska/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function aj:aska/animations/idle/zzz/apply_frame {frame: $(to_frame)}
