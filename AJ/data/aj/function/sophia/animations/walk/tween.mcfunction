...
execute at @s run function aj:sophia/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function aj:sophia/animations/walk/zzz/apply_frame {frame: $(to_frame)}
