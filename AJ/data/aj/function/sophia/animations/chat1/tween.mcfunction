...
execute at @s run function aj:sophia/animations/chat1/zzz/apply_frame {frame: 0}
$execute at @s run function aj:sophia/animations/chat1/zzz/apply_frame {frame: $(to_frame)}
