...
execute at @s run function aj:sophia/animations/idle2/zzz/apply_frame {frame: 0}
$execute at @s run function aj:sophia/animations/idle2/zzz/apply_frame {frame: $(to_frame)}
