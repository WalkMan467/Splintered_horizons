...
function aj:selena/animations/pause_all
...
execute at @s run function aj:selena/animations/chat1/zzz/apply_frame {frame: 0}
$execute at @s run function aj:selena/animations/chat1/zzz/apply_frame {frame: $(to_frame)}
