...
execute at @s run function aj:selena/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function aj:selena/animations/idle/zzz/apply_frame {frame: $(to_frame)}
