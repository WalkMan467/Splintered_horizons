...
tag @s add aj.stellar.animation.earthquake_axe.playing
$scoreboard players set @s aj.tween_duration $(duration)
$scoreboard players set @s aj.earthquake_axe.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function aj:stellar/animations/earthquake_axe/zzz/apply_frame {frame: 0}
$execute at @s run function aj:stellar/animations/earthquake_axe/zzz/apply_frame {frame: $(to_frame)}
