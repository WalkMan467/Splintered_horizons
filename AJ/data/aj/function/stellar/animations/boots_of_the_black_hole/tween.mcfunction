...
execute at @s run function aj:stellar/animations/boots_of_the_black_hole/zzz/apply_frame {frame: 0}
$execute at @s run function aj:stellar/animations/boots_of_the_black_hole/zzz/apply_frame {frame: $(to_frame)}
