...
tag @s add aj.stellar.animation.cutscene_world_tree_2.playing
...
execute at @s run function aj:stellar/animations/cutscene_world_tree_2/zzz/apply_frame {frame: 0}
$execute at @s run function aj:stellar/animations/cutscene_world_tree_2/zzz/apply_frame {frame: $(to_frame)}
