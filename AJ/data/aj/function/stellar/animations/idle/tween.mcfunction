...
tag @s add aj.stellar.animation.idle.playing
...
execute at @s run function aj:stellar/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function aj:stellar/animations/idle/zzz/apply_frame {frame: $(to_frame)}
