...
tag @s add aj.stellar.animation.sit_down.playing
...
execute at @s run function aj:stellar/animations/sit_down/zzz/apply_frame {frame: 0}
$execute at @s run function aj:stellar/animations/sit_down/zzz/apply_frame {frame: $(to_frame)}
