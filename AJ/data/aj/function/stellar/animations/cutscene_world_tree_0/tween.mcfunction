...
tag @s add aj.stellar.animation.cutscene_world_tree_0.playing
...
execute at @s run function aj:stellar/animations/cutscene_world_tree_0/zzz/apply_frame {frame: 0}
$execute at @s run function aj:stellar/animations/cutscene_world_tree_0/zzz/apply_frame {frame: $(to_frame)}
