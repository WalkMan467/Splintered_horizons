...
tag @s add aj.stellar.animation.earthquake_axe2.playing
...
execute at @s run function aj:stellar/animations/earthquake_axe2/zzz/apply_frame {frame: 0}
$execute at @s run function aj:stellar/animations/earthquake_axe2/zzz/apply_frame {frame: $(to_frame)}
