...
tag @s add aj.stellar.animation.walk.playing
...
execute at @s run function aj:stellar/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function aj:stellar/animations/walk/zzz/apply_frame {frame: $(to_frame)}
