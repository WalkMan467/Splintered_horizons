...
function aj:memory_afterimage/animations/pause_all
tag @s add aj.memory_afterimage.animation.idle.playing
...
execute at @s run function aj:memory_afterimage/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function aj:memory_afterimage/animations/idle/zzz/apply_frame {frame: $(to_frame)}
