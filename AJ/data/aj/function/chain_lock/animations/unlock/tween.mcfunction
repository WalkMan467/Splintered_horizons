...
execute at @s run function aj:chain_lock/animations/unlock/zzz/apply_frame {frame: 0}
$execute at @s run function aj:chain_lock/animations/unlock/zzz/apply_frame {frame: $(to_frame)}
