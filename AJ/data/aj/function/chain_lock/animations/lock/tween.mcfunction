...
function aj:chain_lock/animations/pause_all
...
execute at @s run function aj:chain_lock/animations/lock/zzz/apply_frame {frame: 0}
$execute at @s run function aj:chain_lock/animations/lock/zzz/apply_frame {frame: $(to_frame)}
