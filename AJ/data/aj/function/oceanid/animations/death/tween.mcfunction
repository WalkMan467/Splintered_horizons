...
execute at @s run function aj:oceanid/animations/death/zzz/apply_frame {frame: 0}
$execute at @s run function aj:oceanid/animations/death/zzz/apply_frame {frame: $(to_frame)}
