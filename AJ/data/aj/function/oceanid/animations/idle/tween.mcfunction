...
execute at @s run function aj:oceanid/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function aj:oceanid/animations/idle/zzz/apply_frame {frame: $(to_frame)}
