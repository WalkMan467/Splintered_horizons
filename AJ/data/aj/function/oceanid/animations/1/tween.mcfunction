...
function aj:oceanid/animations/pause_all
...
execute at @s run function aj:oceanid/animations/1/zzz/apply_frame {frame: 0}
$execute at @s run function aj:oceanid/animations/1/zzz/apply_frame {frame: $(to_frame)}
