...
execute at @s run function aj:oceanid/animations/2/zzz/apply_frame {frame: 0}
$execute at @s run function aj:oceanid/animations/2/zzz/apply_frame {frame: $(to_frame)}
