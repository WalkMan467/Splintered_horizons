...
function aj:isokla/animations/pause_all
...
$scoreboard players set @s aj.cutscene_chapter_2_1_safe_area_1.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function aj:isokla/animations/cutscene_chapter_2_1_safe_area_1/zzz/apply_frame {frame: 0}
$execute at @s run function aj:isokla/animations/cutscene_chapter_2_1_safe_area_1/zzz/apply_frame {frame: $(to_frame)}
