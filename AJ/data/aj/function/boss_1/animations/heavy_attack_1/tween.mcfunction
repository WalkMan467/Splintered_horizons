...
execute at @s run function aj:boss_1/animations/heavy_attack_1/zzz/apply_frame {frame: 0}
$execute at @s run function aj:boss_1/animations/heavy_attack_1/zzz/apply_frame {frame: $(to_frame)}
