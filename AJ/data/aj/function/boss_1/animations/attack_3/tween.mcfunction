...
tag @s add aj.boss_1.animation.attack_3.playing
$scoreboard players set @s aj.tween_duration $(duration)
$scoreboard players set @s aj.attack_3.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function aj:boss_1/animations/attack_3/zzz/apply_frame {frame: 0}
$execute at @s run function aj:boss_1/animations/attack_3/zzz/apply_frame {frame: $(to_frame)}
