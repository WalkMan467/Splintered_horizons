...
execute at @s run function aj:boss_1/animations/cutscene_attack/zzz/apply_frame {frame: 0}
$execute at @s run function aj:boss_1/animations/cutscene_attack/zzz/apply_frame {frame: $(to_frame)}
