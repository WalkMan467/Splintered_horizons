...
execute at @s run function aj:segrina/animations/spawn/zzz/apply_frame {frame: 0}
$execute at @s run function aj:segrina/animations/spawn/zzz/apply_frame {frame: $(to_frame)}
