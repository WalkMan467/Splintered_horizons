...
execute at @s run function aj:irina/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function aj:irina/animations/idle/zzz/apply_frame {frame: $(to_frame)}
