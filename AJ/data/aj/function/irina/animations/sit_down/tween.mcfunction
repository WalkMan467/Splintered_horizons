...
function aj:irina/animations/pause_all
...
execute at @s run function aj:irina/animations/sit_down/zzz/apply_frame {frame: 0}
$execute at @s run function aj:irina/animations/sit_down/zzz/apply_frame {frame: $(to_frame)}
