...
function aj:kyle/animations/pause_all
...
execute at @s run function aj:kyle/animations/cutscene_attack_1/zzz/apply_frame {frame: 0}
$execute at @s run function aj:kyle/animations/cutscene_attack_1/zzz/apply_frame {frame: $(to_frame)}
