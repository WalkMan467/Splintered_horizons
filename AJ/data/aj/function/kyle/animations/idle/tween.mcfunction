...
execute at @s run function aj:kyle/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function aj:kyle/animations/idle/zzz/apply_frame {frame: $(to_frame)}
