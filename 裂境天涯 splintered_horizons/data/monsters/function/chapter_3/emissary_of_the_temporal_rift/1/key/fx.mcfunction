...
execute rotated ~3 0 if score #monster.emissary_of_the_temporal_rift.key.fx particle matches ..360 run function monsters:chapter_3/emissary_of_the_temporal_rift/1/key/fx