...
execute as @n[tag=monsters.corroder.raycast,tag=summon,type=block_display] run tp @s ~ ~ ~ facing ^ ^ ^1
execute as @n[tag=monsters.corroder.eye,tag=summon,type=item_display] run tp @s ~ ~ ~ facing ^ ^ ^1
