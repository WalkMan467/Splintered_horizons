execute if score @s monster.skill.freeze matches 0.. run function monsters:chapter_3/bloody_blade_spider/cast/end
...
execute rotated ~ 0 run function monsters:chapter_3/bloody_blade_spider/1/fx
...
execute as @a[distance=..6,tag=monsters.bloody_blade_spider.target] if score @s entity.dummy_mob matches 1.. run tag @s remove monsters.bloody_blade_spider.target

tag @p[distance=..6,tag=monsters.bloody_blade_spider.target] add temp

tag @s add victim
execute as @p[distance=..6,tag=monsters.bloody_blade_spider.target,tag=temp] at @s run function monsters:chapter_3/bloody_blade_spider/effect/bleeding/use
tag @s remove victim