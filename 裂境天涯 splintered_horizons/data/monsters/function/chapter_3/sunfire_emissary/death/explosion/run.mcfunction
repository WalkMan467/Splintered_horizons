# ===================================================
# 烈陽使者 自爆 生成燃燒態本體 / sunfire emissary spawn burning form
...
playsound minecraft:voice.aquilumera_light voice @a ~ ~1 ~ 1 1