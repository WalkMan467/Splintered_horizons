...
execute as @e[tag=monsters.sunfire_emissary.fx_2.main,type=area_effect_cloud,tag=summon] at @s rotated 0 -90 run function monsters:chapter_3/sunfire_emissary/death/fx_2/use
