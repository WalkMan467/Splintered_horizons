execute as @a[distance=..3] run damage @s 5 mob_attack by @n[distance=..6,type=husk,tag=monsters.sunfire_emissary]
execute as @a[distance=..3] run function monsters:chapter_3/sunfire_emissary/1/fire/use
