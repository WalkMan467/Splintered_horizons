...
scoreboard players set 000000d4-0000-0002-0000-000100000002 monster.broken_moon.skill.3.cd 50
scoreboard players set max monster.broken_moon.skill.3.cd 60
scoreboard players set 000000d4-0000-0002-0000-000100000002 monster.broken_moon.skill.4.cd 5
