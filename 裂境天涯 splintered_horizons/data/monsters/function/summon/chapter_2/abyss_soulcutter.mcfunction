...
summon stray 1721 101 889 {UUID:[I; 20, 20 , 1, 25],CustomNameVisible:1b,DeathLootTable:"-",PersistenceRequired:1b,NoAI:1b,Health:600f,Tags:["hide_skill_tip","monster","monsters.abyss_soulcutter","monsters.chapter_2","monsters.spawn"],Passengers:[{id:"minecraft:marker",Tags:["monster.marker"],data:{Death:"chapter_2/abyss_soulcutter"}}],CustomName:{"bold":true,"color":"dark_red","fallback":"「Broken Moon」 Larsis","italic":false,"translate":"monsters.abyss_soulcutter"},equipment:{head:{id:"minecraft:leather_helmet",count:1,components:{"minecraft:equippable":{slot:"head",asset_id:"air"}}}},drop_chances:{head:0.000},active_effects:[{id:"minecraft:invisibility",amplifier:255,duration:-1,show_particles:0b,show_icon:0b,ambient:0b}],attributes:[{id:"minecraft:armor",base:5},{id:"minecraft:armor_toughness",base:3},{id:"minecraft:attack_damage",base:0},{id:"minecraft:explosion_knockback_resistance",base:0.65},{id:"minecraft:knockback_resistance",base:0.35},{id:"minecraft:max_health",base:600}]}
