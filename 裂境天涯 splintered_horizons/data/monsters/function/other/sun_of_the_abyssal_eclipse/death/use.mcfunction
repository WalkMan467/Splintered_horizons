...
execute \
    as @e[tag=monsters.sun_of_the_abyssal_eclipse.fx_2.main,type=area_effect_cloud,tag=summon] at @s rotated 0 -90 run \
function monsters:other/sun_of_the_abyssal_eclipse/death/fx_2/use
