...
execute as @e[type=area_effect_cloud,tag=monster.sun_of_the_abyssal_eclipse.1.raycast] run function monsters:other/sun_of_the_abyssal_eclipse/1/raycast/detect
