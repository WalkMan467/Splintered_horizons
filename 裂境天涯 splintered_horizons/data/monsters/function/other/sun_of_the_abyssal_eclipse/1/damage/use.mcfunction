execute as @a[distance=..3] run damage @s 5 mob_attack by @n[distance=..6,type=husk,tag=monsters.sun_of_the_abyssal_eclipse]
execute as @a[distance=..3] run function monsters:other/sun_of_the_abyssal_eclipse/1/fire/use
