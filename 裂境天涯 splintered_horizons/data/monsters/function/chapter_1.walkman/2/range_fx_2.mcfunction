...
particle end_rod ^ ^1 ^1 ^ ^ ^1000000 0.0000025 0 force

execute rotated ~3 0 if score #boss.chapter_1.walkman.2 particle matches ..360 run function monsters:chapter_1.walkman/2/range_fx_2