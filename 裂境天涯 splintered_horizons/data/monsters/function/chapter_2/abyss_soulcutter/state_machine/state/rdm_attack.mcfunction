execute store result score #monster.abyss_soulcutter.attack.rdm global.main run random value 1..3
...
execute if score #monster.abyss_soulcutter.attack.rdm global.main matches 3 run function monsters:chapter_2/abyss_soulcutter/state_machine/state/attack_3