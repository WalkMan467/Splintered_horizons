...
scoreboard players set @s monster.abyss_soulcutter.state_machine.action 100

effect give @s slowness 6 1 true
execute on passengers run function animated_java:boss_1/animations/attack_1/tween {to_frame:10, duration:10}
