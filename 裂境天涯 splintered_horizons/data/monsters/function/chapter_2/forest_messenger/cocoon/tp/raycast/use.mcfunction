...
execute as @e[tag=monster.forest_messenger.cocoon.tp.raycast,type=area_effect_cloud] at @s run function monsters:chapter_2/forest_messenger/cocoon/tp/raycast/main
