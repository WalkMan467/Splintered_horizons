...
summon block_display ^ ^1 ^8 {Glowing:1b,teleport_duration:1,glow_color_override:16770560,Tags:["monster.forest_messenger.cocoon","summon","monster.forest_messenger.cocoon.display"],Passengers:[{id:"minecraft:block_display",Glowing:1b,teleport_duration:1,glow_color_override:16770560,brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.25f,-0.125f,-0.25f],scale:[0.5f,0.5f,0.5f]},block_state:{id:"minecraft:azalea"}},{id:"minecraft:block_display",Glowing:1b,teleport_duration:1,glow_color_override:16770560,brightness:{sky:15,block:15},transformation:{left_rotation:[1f,0f,0f,0f],right_rotation:[0f,0f,0f,1f],translation:[-0.25f,0.125f,0.25f],scale:[0.5f,0.5f,0.5f]},block_state:{id:"minecraft:azalea"}},{id:"minecraft:block_display",Glowing:1b,billboard:"vertical",teleport_duration:1,glow_color_override:16770560,brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.25f,0.375f,-0.25f],scale:[0.5f,0.5f,0.5f]},block_state:{id:"minecraft:bush"}},{id:"minecraft:block_display",Glowing:1b,billboard:"vertical",teleport_duration:1,glow_color_override:16770560,brightness:{sky:15,block:15},transformation:{left_rotation:[1f,0f,0f,0f],right_rotation:[0f,0f,0f,1f],translation:[-0.25f,-0.375f,0.25f],scale:[0.5f,0.5f,0.5f]},block_state:{id:"minecraft:bush"}}],brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.175f,-0.175f,-0.175f],scale:[0.375f,0.375f,0.375f]},block_state:{id:"minecraft:raw_gold_block"}}
