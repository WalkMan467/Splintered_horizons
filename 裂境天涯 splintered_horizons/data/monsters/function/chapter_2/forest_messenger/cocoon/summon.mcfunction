...
summon block_display ^ ^1 ^8 {teleport_duration:1,Tags:["monster.forest_messenger.cocoon","summon","monster.forest_messenger.cocoon.display"],Passengers:[{id:"minecraft:block_display",teleport_duration:1,brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.25f,-0.125f,-0.25f],scale:[0.5f,0.5f,0.5f]},block_state:{Name:"minecraft:azalea"}},{id:"minecraft:block_display",teleport_duration:1,brightness:{sky:15,block:15},transformation:{left_rotation:[1f,0f,0f,0f],right_rotation:[0f,0f,0f,1f],translation:[-0.25f,0.125f,0.25f],scale:[0.5f,0.5f,0.5f]},block_state:{Name:"minecraft:azalea"}},{id:"minecraft:block_display",billboard:"vertical",teleport_duration:1,brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.25f,0.375f,-0.25f],scale:[0.5f,0.5f,0.5f]},block_state:{Name:"minecraft:bush"}},{id:"minecraft:block_display",billboard:"vertical",teleport_duration:1,brightness:{sky:15,block:15},transformation:{left_rotation:[1f,0f,0f,0f],right_rotation:[0f,0f,0f,1f],translation:[-0.25f,-0.375f,0.25f],scale:[0.5f,0.5f,0.5f]},block_state:{Name:"minecraft:bush"}}],brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.175f,-0.175f,-0.175f],scale:[0.375f,0.375f,0.375f]},block_state:{Name:"minecraft:raw_gold_block"}}
