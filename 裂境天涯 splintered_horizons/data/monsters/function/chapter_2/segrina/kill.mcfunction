...
execute as @a run function monsters:chapter_2/segrina/4/5
...
scoreboard players reset ffff8285-0000-0c33-0000-5a5c0162349d monster.segrina.skill.2.casting
scoreboard players reset ffff8285-0000-0c33-0000-5a5c0162349d monster.segrina.skill.3.casting
