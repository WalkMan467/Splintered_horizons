...
# Bossbar
execute store result bossbar minecraft:monsters.elekiel_phase_2 max run attribute @s max_health get
execute store result bossbar minecraft:monsters.elekiel_phase_2 value run data get entity @s Health
