...
scoreboard players set #opacity mob.main 255
...
scoreboard players set #opacity mob.main 229

execute \
    if score @s mob.duration matches 12 run \
scoreboard players set #opacity mob.main 204

execute \
    if score @s mob.duration matches 13 run \
scoreboard players set #opacity mob.main 178

execute \
    if score @s mob.duration matches 14 run \
scoreboard players set #opacity mob.main 153

execute \
    if score @s mob.duration matches 15 run \
scoreboard players set #opacity mob.main 127

execute \
    if score @s mob.duration matches 16 run \
scoreboard players set #opacity mob.main 102

execute \
    if score @s mob.duration matches 17 run \
scoreboard players set #opacity mob.main 76

execute \
    if score @s mob.duration matches 18 run \
scoreboard players set #opacity mob.main 50
