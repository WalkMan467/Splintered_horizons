...
execute if score @s monster.elekiel_phase_2.skill.4.portal.tp.cd matches 1.. run return 0
execute unless score #monster.elekiel_phase_2.skill.4.portal.actived global.main matches 1.. run return 0
execute if entity @s[tag=monster.elekiel_phase_2.skill.4.effect.void] run return 0
execute if entity @s[tag=monsters.elekiel_phase_2.portal.tp.player] run return 0
execute if entity @s[tag=!animation,gamemode=spectator] run return 0
...
execute summon block_display at @s run function particle:portal/crack/tp/setup
