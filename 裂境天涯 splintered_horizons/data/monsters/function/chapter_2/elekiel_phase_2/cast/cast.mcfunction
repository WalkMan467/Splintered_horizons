...
function monsters:chapter_2/elekiel_phase_2/1/use

execute \
    if score skill.2 monster.elekiel_phase_2.cd matches ..-1 run \
function monsters:chapter_2/elekiel_phase_2/2/use
...
function monsters:chapter_2/elekiel_phase_2/4/use

execute \
    if score skill.5 monster.elekiel_phase_2.cd matches ..-1 run \
function monsters:chapter_2/elekiel_phase_2/5/use