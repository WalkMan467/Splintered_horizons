...
execute \
    positioned 917 59.5 3023 run \
function particle:tunder_red/use {duration:20,spread:1}

execute \
    positioned 921 59.5 3024 run \
function particle:tunder_red/use {duration:20,spread:1}

execute \
    positioned 913 59.5 3014 run \
function particle:tunder_red/use {duration:20,spread:1}

execute \
    positioned 907 59.5 3012 run \
function particle:tunder_red/use {duration:20,spread:1}

execute \
    positioned 899 59.5 3015 run \
function particle:tunder_red/use {duration:20,spread:1}

execute \
    positioned 891 59.5 3011 run \
function particle:tunder_red/use {duration:20,spread:1}

execute \
    positioned 889 59.5 3005 run \
function particle:tunder_red/use {duration:20,spread:1}

execute \
    positioned 887 59.5 3013 run \
function particle:tunder_red/use {duration:20,spread:1}

execute \
    positioned 912 59.5 3023 run \
function particle:tunder_red/use {duration:20,spread:1}

execute \
    positioned 931 59.5 3019 run \
function particle:tunder_red/use {duration:20,spread:1}

execute \
    positioned 937 59.5 3026 run \
function particle:tunder_red/use {duration:20,spread:1}

execute \
    positioned 933 59.5 3031 run \
function particle:tunder_red/use {duration:20,spread:1}
