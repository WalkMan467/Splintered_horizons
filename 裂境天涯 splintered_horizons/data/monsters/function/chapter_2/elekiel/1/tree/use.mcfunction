...
execute \
    as @e[distance=0..,tag=monsters.elekiel.2.tree,tag=summon,type=block_display] run \
...
execute \
    as @e[distance=0..,tag=monsters.elekiel.2.tree,tag=summon,type=block_display] \
    store result score @s monster.elekiel.1.rdm_monsters run \
random value 1..4


execute \
    as @e[distance=0..,tag=monsters.elekiel.2.tree,tag=summon,type=block_display] at @s \
...
tag @e[distance=0..,tag=monsters.elekiel.2.tree,tag=summon,type=block_display] remove summon