...
execute store result bossbar chapter_2.elekiel.3 value run scoreboard players get global monster.elekiel.3.timer
...
execute on target run tag @s[tag=this] remove this