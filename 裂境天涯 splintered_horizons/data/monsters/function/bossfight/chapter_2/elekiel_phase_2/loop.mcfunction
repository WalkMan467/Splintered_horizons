...
function monsters:bossfight/chapter_2/elekiel_phase_2/reset_player_die
...
execute \
    unless entity @a[tag=!chapter_2.elekiel_phase_2.lose] \
    if score #boss_area.chapter_2.elekiel_phase_2 global.main matches 1.. run \
function monsters:bossfight/chapter_2/elekiel_phase_2/lose
