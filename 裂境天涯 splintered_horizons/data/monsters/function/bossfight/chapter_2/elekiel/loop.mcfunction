...
execute \
    ...
    if biome ~ ~ ~ world_area:chapter_2/bossfight/normal \
    as @a[tag=chapter_2.elekiel.lose] \
    positioned 912 60 2018 \
    unless entity @s[distance=..40] run \
tp @s 1109 82 373 0 0

execute \
    as 00000100-0000-0080-0000-008000000001 at @s \
    if biome ~ ~ ~ world_area:chapter_2/bossfight/fire \
    as @a[tag=chapter_2.elekiel.lose] \
    positioned 912 60 3018 \
    unless entity @s[distance=..40] run \
tp @s 912 60 3018 0 0

scoreboard players set @a[tag=chapter_2.elekiel.lose] player.animation.lock 10

execute \
    unless entity @a[tag=!chapter_2.elekiel.lose] \
