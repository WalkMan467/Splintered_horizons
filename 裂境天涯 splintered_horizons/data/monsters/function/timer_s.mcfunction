...
execute if score .global monster.elekiel.3.player_pos.save.timer matches 0 as @a at @s if biome ~ ~ ~ #world_area:chapter_2_bossfight run function monsters:chapter_2/elekiel/3/save_pos
...
execute if score .global monster.elekiel.3.timer matches 0..6 as @a at @s run function monsters:chapter_2/elekiel/3/clock
