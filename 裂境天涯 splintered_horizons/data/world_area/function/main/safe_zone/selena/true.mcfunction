...
execute \
    positioned 766 146 966 run \
tag @n[tag=aj.selena.root,distance=..2] add world_area.main.safe_zone.selena

summon interaction 766 146 966 {Tags:["world_area.main.safe_zone.selena.act","interaction.sound.default"],height:2,UUID:[I; 2, 22, 51, 55]}
