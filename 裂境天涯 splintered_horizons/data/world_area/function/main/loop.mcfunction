...
# 全局
    ...
    # 營火
    execute if entity @s[gamemode=!spectator] if entity @n[tag=system.campfire,limit=1,distance=..6,type=minecraft:interaction] unless entity @n[distance=..6,type=!#minecraft:dummy_mob,type=!minecraft:player] run advancement grant @s only world_area:main/campfire/in
    execute if entity @s[gamemode=!spectator] if entity @n[tag=system.campfire,limit=1,distance=..6,type=minecraft:interaction] if entity @n[distance=..6,type=!#minecraft:dummy_mob,type=!minecraft:player] run advancement grant @s only world_area:main/campfire/out
