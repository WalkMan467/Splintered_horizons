...
execute as @e[tag=world_area.realm_of_the_black_hole.fx_2,type=area_effect_cloud] run function world_area:chapter_1/realm_of_the_black_hole/objects/fx_2/rotation

execute as @e[tag=world_area.realm_of_the_black_hole.fx_2,type=area_effect_cloud] at @s run tp @s ~ ~20 ~
execute as @e[tag=world_area.realm_of_the_black_hole.fx_2,type=area_effect_cloud] at @s run function particle:lightning/bolt_start