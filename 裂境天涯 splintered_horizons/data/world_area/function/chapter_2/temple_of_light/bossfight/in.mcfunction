...
execute \
    if entity 000009ed-0000-007b-0000-000100000001 run \
return 0

execute \
    if entity 00000806-0000-0002-0000-001f00000003 run \
return 0
...
execute \
    ...
    as @n[distance=..3,type=item_display,tag=aj.boss_1.root] run \
