## ---異界傳送門--- ##
    ...
    # Detect
    execute positioned 6 35 97.0 in minecraft:the_end store result score #world_area.other.otherworld_portal.1 global.main if entity @a[distance=..5,gamemode=!spectator]
    execute positioned 6 35 97.0 in minecraft:the_end if entity @a[distance=..5,gamemode=!spectator] run scoreboard players add #world_area.other.otherworld_portal.1 world_area.other.otherworld_portal.delay 1
