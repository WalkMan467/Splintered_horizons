...
execute unless score #world_area.other.otherworld_portal.4.lock global.main matches 1.. run return 0
execute on target if score @s player.otherworld_key.count matches 0 run function world_area:other/otherworld_portal/4/lock/false
