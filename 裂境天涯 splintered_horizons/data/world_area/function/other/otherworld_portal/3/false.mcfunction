...
execute positioned 430.00 93.00 -146.50 rotated -90 0 in minecraft:the_end as @e[tag=aj.portal.root,distance=..3] run function animated_java:portal/remove/this
