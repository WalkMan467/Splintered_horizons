...
scoreboard players set @s music.main.campfire 1
...
scoreboard players set @s music.chapter2.land_of_finality 1

execute \
    if biome ~ ~ ~ world_area:main/safe_zone run \
scoreboard players set @s music.main.safe_zone 1

execute \
    if biome ~ ~ ~ world_area:chapter_2/forest_of_souls run \
scoreboard players set @s music.chapter2.forest_of_souls 1

execute \
    if biome ~ ~ ~ world_area:chapter_2/forgotten_sakura_city run \
scoreboard players set @s music.chapter2.forgotten_sakura_city 1

execute \
    if biome ~ ~ ~ world_area:other/the_forgooten_lost_city run \
scoreboard players set @s music.other.the_forgooten_lost_city 1

execute \
    if biome ~ ~ ~ #world_area:chapter_2_end run \
scoreboard players set @s music.chapter2.temple_of_light 1

execute \
    if biome ~ ~ ~ world_area:chapter_3/finalitys_embrace_rift run \
scoreboard players set @s music.chapter3.finalitys_embrace_rift 1

execute \
    if biome ~ ~ ~ world_area:chapter_3/realm_of_finality run \
scoreboard players set @s music.chapter3.realm_of_finality 1

execute \
    if biome ~ ~ ~ world_area:other/hasanor run \
scoreboard players set @s music.other.hasanor 1
...
scoreboard players set @s music.main.safe_zone 0

execute \
    unless biome ~ ~ ~ world_area:chapter_2/forest_of_souls run \
scoreboard players set @s music.chapter2.forest_of_souls 0

execute \
    unless biome ~ ~ ~ world_area:chapter_2/forgotten_sakura_city run \
scoreboard players set @s music.chapter2.forgotten_sakura_city 0

execute \
    unless biome ~ ~ ~ world_area:other/the_forgooten_lost_city run \
scoreboard players set @s music.other.the_forgooten_lost_city 0

execute \
    unless biome ~ ~ ~ #world_area:chapter_2_end run \
scoreboard players set @s music.chapter2.temple_of_light 0

execute \
    unless biome ~ ~ ~ world_area:chapter_3/finalitys_embrace_rift run \
scoreboard players set @s music.chapter3.finalitys_embrace_rift 0
...
scoreboard players set @s music.other.hasanor 0
