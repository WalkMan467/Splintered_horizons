...
execute anchored eyes positioned ^ ^ ^100 run summon marker ~ ~ ~ {UUID:[I;2036214966,1735214453,-1311675431,-154367856]}
execute as @e[tag=sys.zipline_platform.act,tag=!sys.zipline_platform.using,distance=..60,type=interaction] facing entity @s feet positioned ^ ^ ^100 run function sys:zipline_platform/interacted/2
execute at 795e2cb6-676d-4575-b1d1-6bd9f6cc8890 as @n[distance=0..,tag=sys.zipline_platform.pos,type=marker] run function sys:zipline_platform/interacted/3
