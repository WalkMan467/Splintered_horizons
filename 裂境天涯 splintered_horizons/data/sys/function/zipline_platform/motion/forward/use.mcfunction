...
item replace entity @s armor.head with poisonous_potato[enchantments={"sys:zipline_platform/forward_motion":1},enchantment_glint_override=false,tooltip_display={},equippable={slot:"head",asset_id:"air"},item_model="air",custom_data={motion_effect:1b}]