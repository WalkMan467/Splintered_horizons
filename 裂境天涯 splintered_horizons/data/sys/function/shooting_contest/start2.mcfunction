...
summon item 1039 153.2 -71 {Age:5990s,PickupDelay:-1,Item:{id:"minecraft:emerald",count:1,components:{"minecraft:max_stack_size":1,item_model:"coin/s"}}}

execute \
    in minecraft:overworld run \
playsound minecraft:block.iron_door.close master @a 1039 153.2 -71 1 2

execute \
    in minecraft:overworld run \
playsound minecraft:entity.villager.work_fletcher master @a 1039 153.2 -71 1 1