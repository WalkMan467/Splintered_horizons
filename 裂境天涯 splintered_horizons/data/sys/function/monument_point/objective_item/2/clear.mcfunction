...
execute \
    unless score #weapon.silvaverdis.count global.main matches 2.. run \
return 0
...
tellraw @p[sort=arbitrary,tag=weapon.silvaverdis.clear,tag=temp] [{"font":"minecraft:space","text":"\ue003\ue002\ue000"},{"font":"minecraft:default","text":"[","color":"white","bold":true},{"font":"minecraft:default","text":"📢","color":"blue","bold":false},{"font":"minecraft:default","text":"]","color":"white","bold":true},{"text":" ","font":"minecraft:default"},{"font":"minecraft:default","text":"\n"},{"font":"minecraft:default","text":"☞ ","color":"dark_gray"},{"translate":"weapon.aquilumera.clear.1","color":"red","font":"default","bold":false,"fallback": "由於偵測到世界上存在多把相同的此武器"}]
tellraw @p[sort=arbitrary,tag=weapon.silvaverdis.clear,tag=temp] [{"font":"minecraft:space","text":"\ue003\ue002\ue000"},{"translate":"weapon.aquilumera.clear.2","color":"red","font":"default","bold":false,"fallback": "已隨機移除多餘的武器"}]
