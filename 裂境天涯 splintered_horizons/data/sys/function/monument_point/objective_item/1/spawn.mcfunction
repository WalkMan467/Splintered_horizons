tp @n[type=item,predicate=sys:monument_point/objective_item/1] @p
data modify entity @n[type=item,predicate=sys:monument_point/objective_item/1] PickupDelay set value 0
