## --- Interaction --- ##
    ...
    # Detect
    execute positioned 765 146 995 store result score #sys.walkman467 global.main \
    if entity @a[distance=..16,gamemode=!spectator]

    execute positioned 765 146 995 as @n[sort=arbitrary,distance=..1,tag=sys.walkman467,type=mannequin] at @s facing entity @p[distance=..16] eyes run rotate @s ~ 0

    # Rotate to Player
    execute positioned 765 146 995 \
