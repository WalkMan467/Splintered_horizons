...
# Nightfall
execute if entity @n[distance=..1.5,predicate=sys:forging_table/crafting/sword/nightfall/moonlight_star,type=item] run function sys:forging_table/crafting/sword/nightfall/run
...
# Twilight Wind
execute if entity @n[distance=..1.5,predicate=sys:forging_table/crafting/sword/twilight_wind/dust_of_the_wind,type=item] run function sys:forging_table/crafting/sword/twilight_wind/run
