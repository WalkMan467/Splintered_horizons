...
kill @n[distance=..1.5,predicate=sys:forging_table/crafting/axe/earthquake_axe/finality_ingot,type=item]

function sys:forging_table/crafting/axe/earthquake_axe/setup