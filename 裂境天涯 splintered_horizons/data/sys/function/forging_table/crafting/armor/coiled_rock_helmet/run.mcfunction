...
kill @n[distance=..1.5,predicate=sys:forging_table/crafting/armor/coiled_rock_helmet/rockbound_crystal,type=item]

function sys:forging_table/crafting/armor/coiled_rock_helmet/setup