...
kill @n[distance=..1.5,predicate=sys:forging_table/crafting/armor/blackhole_boots/phase_crystal,type=item]

function sys:forging_table/crafting/armor/blackhole_boots/setup