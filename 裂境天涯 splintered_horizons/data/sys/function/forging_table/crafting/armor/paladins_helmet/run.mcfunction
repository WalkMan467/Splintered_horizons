...
kill @n[distance=..1.5,predicate=sys:forging_table/crafting/armor/paladins_helmet/holy_light_iron_ingot,type=item]

function sys:forging_table/crafting/armor/paladins_helmet/setup