...
execute unless score @s sys.dmg_show.hpmax matches -2147483648..2147483647 run function sys:dmg_show/get_hpmax
...
execute unless score @s sys.dmg_show.hpmax = #hp sys.dmg_show.main run function sys:dmg_show/use