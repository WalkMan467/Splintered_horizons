...
execute if items entity @s weapon.mainhand bow[custom_data~{weapon:"sagittarius"}] run item modify entity @s weapon.mainhand weapons:type/bow/sagittarius/0
execute if items entity @s weapon.offhand bow[custom_data~{weapon:"sagittarius"}] run item modify entity @s weapon.offhand weapons:type/bow/sagittarius/0