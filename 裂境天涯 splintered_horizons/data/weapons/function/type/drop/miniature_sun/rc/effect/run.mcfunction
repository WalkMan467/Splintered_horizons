summon area_effect_cloud ~ ~0.5 ~ {Tags:["weapon.miniature_sun.main","summon"],Duration:100}
summon area_effect_cloud ~ ~3 ~ {Tags:["weapon.miniature_sun.main.fx","summon"],Duration:100}
