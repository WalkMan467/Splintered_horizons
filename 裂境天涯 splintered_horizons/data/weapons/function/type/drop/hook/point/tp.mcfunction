...
execute on passengers if entity @s[type=player] run scoreboard players set @s player.disable.elytra_switch 16
execute on passengers if entity @s[type=player] run scoreboard players set @s player.shift.skill.disable 16
