...
execute on attacker run function weapons:type/sword/rock_crushing_greatsword/rc/apply_motion

execute store result score #rdm global.main run random value 1..3
execute if score #rdm global.main matches 1 run playsound minecraft:voice.deflect voice @a ~ ~1 ~ 0.5 0.75
execute if score #rdm global.main matches 2 run playsound minecraft:voice.deflect voice @a ~ ~1 ~ 0.5 1
execute if score #rdm global.main matches 3 run playsound minecraft:voice.deflect voice @a ~ ~1 ~ 0.5 1.25
