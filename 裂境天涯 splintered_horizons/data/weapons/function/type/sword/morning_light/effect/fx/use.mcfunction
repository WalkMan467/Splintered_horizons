...
execute \
    as @e[type=item_display,limit=1,tag=weapon.morning_light,tag=summon] at @s run \
tp @s ~ ~-3 ~ 0 0

execute \
    as @e[type=item_display,limit=1,tag=weapon.morning_light,tag=summon] run \
...
particle minecraft:flash{color:[1.000,0.835,0.000,1.00]} ~ ~1 ~ 0 0 0 1 1
