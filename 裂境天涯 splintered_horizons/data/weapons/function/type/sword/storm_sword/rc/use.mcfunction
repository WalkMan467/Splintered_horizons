...
execute unless score @s player.ultimate matches 0 if score @s weapon.eye_of_the_end.interval matches ..1 run function weapons:skill_use_failed
execute unless score @s player.ultimate matches 0 run return fail
