execute as @e[distance=..3,type=!#minecraft:dummy_mob,type=!player] run effect give @s glowing 1 255 true
tp @p[tag=weapon.ruins_of_the_finality.blade.1.user] ~ ~ ~
execute as @p[tag=weapon.ruins_of_the_finality.blade.1.user] at @s run function weapons:type/scythe/ruins_of_the_finality/rc/blade/1/use
...
execute as @p[tag=weapon.ruins_of_the_finality.blade.1.user] run function dmg_formula:weapons/type/scythe/ruins_of_the_finality/calculate
