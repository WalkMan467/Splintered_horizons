...
execute as @e[type=area_effect_cloud,tag=weapon.ruins_of_the_finality.effect.point.main] rotated ~ 0 run function weapons:type/scythe/ruins_of_the_finality/rc/blade/1/raycast/detect
