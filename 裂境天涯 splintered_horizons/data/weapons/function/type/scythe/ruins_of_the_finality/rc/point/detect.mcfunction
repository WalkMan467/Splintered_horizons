...
execute if score #temp weapon.ruins_of_the_finality.effect.range matches 2.. positioned ^ ^ ^0.5 unless block ~ ~ ~ #penetrate run summon area_effect_cloud ^ ^ ^ {custom_particle:{type:"block",block_state:"air"},Radius:0,Duration:1,Tags:["weapon.ruins_of_the_finality.effect.chain.final.point"]}
