...
tag @s add weapon.earthquake_axe.finality_tunder

execute \
    if score @s player.finality_tunder matches 1.. run \
scoreboard players set @s weapon.earthquake_axe.animation 60

execute \
    unless score @s player.finality_tunder matches 1.. run \
scoreboard players set @s weapon.earthquake_axe.animation 30
