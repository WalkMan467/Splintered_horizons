...
execute \
    as @e[type=item_display,tag=aj.stellar_animation.root,tag=aj.stellar_animation.animation.earthquake_axe.playing,tag=!delete,distance=..10,limit=1] \
...
execute \
    as @n[type=item_display,distance=..10,tag=aj.stellar_animation.root,tag=aj.stellar_animation.animation.earthquake_axe.playing,tag=delete] at @s run \
