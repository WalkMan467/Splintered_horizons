...
execute \
    if score @s weapon.earthquake_axe.hit.sfx matches 1 run \
playsound minecraft:voice.attack_sound voice @a ~ ~1 ~ 3 1
...
execute \
    if score @s weapon.earthquake_axe.hit.sfx matches 2 run \
playsound minecraft:voice.attack_sound voice @a ~ ~1 ~ 3 1.05
...
execute \
    if score @s weapon.earthquake_axe.hit.sfx matches 3.. run \
playsound minecraft:voice.attack_sound voice @a ~ ~1 ~ 3 1.1
...
execute \
    if score @s weapon.earthquake_axe.hit.sfx matches 3.. run \
playsound minecraft:entity.warden.sonic_boom voice @a ~ ~1 ~ 3 1.5
...
execute \
    as @p[distance=..8,sort=arbitrary,tag=atker,tag=temp] run \
function dmg_formula:weapons/type/axe/earthquake_axe/calculate
