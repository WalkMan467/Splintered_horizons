...
#item_data     = {'real_item': 'stone_sword', 'id': 'silvaverdis', 'item_model': '"sword/silvaverdis/1"', 'custom_data': '{rc:1b,type:"sword",weapon:"silvaverdis",monument:2b}', 'max_damage': -1}
