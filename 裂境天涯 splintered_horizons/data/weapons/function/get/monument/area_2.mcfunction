...
#item_data     = {'real_item': 'stone_sword', 'id': 'silvaverdis', 'item_model': '"sword/silvaverdis/1"', 'custom_data': 'type:"sword",rarity:"monument",weapon:"silvaverdis",monument:2,kept_item:true', 'max_damage': -1, 'rc': False, 'lc': False, 'other': ['']}
