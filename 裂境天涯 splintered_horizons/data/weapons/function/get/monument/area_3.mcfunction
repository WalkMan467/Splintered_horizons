...
#item_data = {'real_item': 'iron_sword', 'id': 'pyrosolis', 'item_model': '"minecraft:sword/infernal_blaze/1"', 'custom_data': 'type:"sword",rarity:"monument",weapon:"pyrosolis",monument:3,kept_item:true', 'max_damage': 300, 'max_stack_size': 1, 'rc': True, 'lc': False, 'other': ['minecraft:enchantments={"minecraft:mending":1}', 'tooltip_style="mythic"', 'enchantment_glint_override=false']}
