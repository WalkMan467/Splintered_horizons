# ===================================================
# get 劍 天地乖離開闢之星 / get kill sword

    ## Guide [ function weapons:get/sword/kill_sword ] >>> get 劍 天地乖離開闢之星 / get kill sword

# ===================================================

give @s iron_sword[item_name=[{"translate": "weapon.kill_sword", "color": "#ff0000", "bold": true}],lore=[[{"translate": "weapon.kill_sword.type", "color": "dark_gray", "italic": false}], {"text": ""}, [{"translate": "weapon.kill_sword.story.1", "color": "blue", "italic": false}], {"text": ""}, [{"text": "", "italic": false}, {"translate": "weapon.kill_sword.skill", "color": "#7a0000", "bold": true}, {"text": "  "}], [{"text": "", "italic": false}, {"translate": "weapon.kill_sword.skill.1", "color": "#ff0000",with:[{keybind:"key.use","underlined":true,"color":"dark_green"}], "italic": false}], {"text": ""}],attribute_modifiers=[{type:"attack_damage",id:"base_attack_damage",amount:9999999,operation:"add_multiplied_total",slot:"mainhand"},{type:"attack_speed",id:"base_attack_speed",amount:9999999,operation:"add_multiplied_total",slot:"mainhand"}],max_stack_size=1,unbreakable={},item_model="sword/enuma_elish/1",custom_data={rc:1b,type:"sword",rarity:"mythic",weapon:"kill_sword"},enchantment_glint_override=false,tooltip_style="legendary",kinetic_weapon={delay_ticks:5,contact_cooldown_ticks:10000,forward_movement:0.0,damage_multiplier:0.0,knockback_conditions:{max_duration_ticks:10000},damage_conditions:{max_duration_ticks:10000}},piercing_weapon={deals_knockback:false,dismounts:false,sound:"item.spear.attack",hit_sound:"item.spear.hit"},attack_animation={duration:20,type:"stab"},damage_type="weapons:type/sword/kill_sword_attack", minimum_attack_charge=0.5]
...
#                 'attack_animation={duration:20,type:"stab"}'
#             ]
#         },
#         "skill": {
#             "is_skill": True,
