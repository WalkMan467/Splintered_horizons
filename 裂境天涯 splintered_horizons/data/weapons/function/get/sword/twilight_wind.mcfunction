...
#item_data = {'real_item': 'stone_sword', 'id': 'twilight_wind', 'item_model': '"sword/wind_sword/2"', 'custom_data': 'rc:0b, type:"sword",rarity:"epic",weapon:"twilight_wind",forging_table:1b', 'max_damage': 150, 'max_stack_size': 1, 'rc': False, 'lc': False, 'other': ['minecraft:enchantments={"weapons:type/sword/twilight_wind/use":1,"minecraft:unbreaking":1}', 'enchantment_glint_override=false', 'tooltip_style="epic"']}
