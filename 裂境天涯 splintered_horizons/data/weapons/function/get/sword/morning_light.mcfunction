...
#item_data     = {'real_item': 'stone_sword', 'id': 'morning_light', 'item_model': '"minecraft:sword/morning_light/1"', 'custom_data': '{type:"sword",rarity:"epic",weapon:"morning_light"}', 'max_damage': 150, 'max_stack_size': 1, 'rc': False, 'other': ['minecraft:enchantments={"weapons:type/sword/morning_light/use":1, "minecraft:mending":1}', 'enchantment_glint_override=false','tooltip_style="epic"']}
