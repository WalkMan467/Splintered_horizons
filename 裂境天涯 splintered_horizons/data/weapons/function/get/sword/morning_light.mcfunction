give @s stone_sword[tooltip_style="rare",item_name='[{"translate":"weapon.morning_light","color":"#ffd000","italic":false,"bold":true}]',lore=['[{"translate":"weapon.morning_light.type","italic":false,"color":"dark_gray"}]','{"text":""}','[{"translate":"weapon.morning_light.story.1","italic":false,"color":"blue"}]','[{"translate":"weapon.morning_light.story.2","italic":false,"color":"blue"}]','[{"translate":"weapon.morning_light.story.3","italic":false,"color":"blue"}]','[{"translate":"weapon.morning_light.story.4","italic":false,"color":"blue"}]','[{"translate":"weapon.morning_light.story.5","italic":false,"color":"blue"}]','{"text":""}','[{"text":"","italic":false},{"translate":"weapon.morning_light.skill","color":"gold","bold":true}]','[{"text":"","italic":false},{"translate":"weapon.morning_light.skill.1","color":"#fffb00"}]','[{"text":"","italic":false},{"translate":"weapon.morning_light.skill.2","color":"#fffb00"}]','[{"text":"","italic":false},{"translate":"weapon.morning_light.skill.3","color":"#fffb00"}]','[{"text":"","italic":false},{"translate":"weapon.morning_light.skill.4","color":"#fffb00"}]'],attribute_modifiers=[{id:"base_attack_damage",type:"attack_damage",amount:3.5,operation:"add_value",slot:"mainhand"},{id:"base_attack_speed",type:"attack_speed",amount:-2.35,operation:"add_value",slot:"mainhand"}],max_stack_size=1,max_damage=150,damage=0,item_model="minecraft:sword/morning_light/1",custom_data={morning_light:1b,type:"sword",weapon:"morning_light"},minecraft:enchantments={levels:{"weapons:type/sword/morning_light/use":1},show_in_tooltip:false},minecraft:enchantment_glint_override=0b]
...
#item_data     = {'real_item': 'stone_sword', 'id': 'morning_light', 'item_model': '"minecraft:sword/morning_light/1"', 'custom_data': '{ultimate:1b,type:"sword",weapon:"morning_light"}', 'max_damage': 150}
