...
#item_data     = {'real_item': 'stone_sword', 'id': 'ruins_of_the_finality', 'item_model': '"sickle/ruins_of_the_finality/1"', 'custom_data': '{rc:1b,type:"sword",weapon:"ruins_of_the_finality"}', 'max_damage': 150}
