...
#item_data     = {'real_item': 'stone_sword', 'id': 'ruins_of_the_finality', 'item_model': '"scythe/ruins_of_the_finality/1"', 'custom_data': 'type:"scythe",rarity:"mythic",weapon:"ruins_of_the_finality",forging_table:1b', 'max_damage': -1, 'rc': True, 'lc': False, 'other': ['tooltip_style="mythic"']}
