...
#item_data     = {'real_item': 'arrow', 'id': 'chaotic_thunder_arrow', 'item_model': '"arrow/chaotic_thunder_arrow"', 'custom_data': 'type:"arrow",rarity:"epic",id:"chaotic_thunder_arrow",ground_detect:1b', 'max_damage': -1, 'rc': False, 'lc': False, 'other': ['tooltip_display={hidden_components:["enchantments","attribute_modifiers","unbreakable"]}', 'tooltip_style="epic"']}
#skill    = {'is_skill': True, 'cd': 0, 'name': ['符文陣 - 渾沌之雷', '#fc007e', '#ff0015'], 'info': ['箭矢命中地板或目標可以生成該符文的符文陣', '可以讓 4 格範圍內玩家持續獲得該符文持續 5 秒']}
