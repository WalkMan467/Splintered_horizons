...
# "weapon.holy_fire_arrow.type" : "箭矢 / 史詩"
# "weapon.holy_fire_arrow.story.1" : "擁有符文力量的箭矢，"
# "weapon.holy_fire_arrow.story.2" : "命中地板或目標可以生成該符文的符文陣"
# "weapon.holy_fire_arrow.skill" : "[符文陣 - 神聖之火]"
# "weapon.holy_fire_arrow.skill.1" : "箭矢命中地板或目標可以生成該符文的符文陣"
# "weapon.holy_fire_arrow.skill.2" : "可以讓 4 格範圍內玩家持續獲得該符文持續 5 秒"

#name = ['神聖之火 - 符文箭矢', '#e6e6e6', '箭矢 / 史詩']
#story = {'info': ['擁有符文力量的箭矢，', '命中地板或目標可以生成該符文的符文陣'], 'color': 'blue'}
#item_data     = {'real_item': 'arrow', 'id': 'holy_fire_arrow', 'item_model': '"arrow/holy_fire_arrow"', 'custom_data': 'type:"arrow",rarity:"epic",id:"holy_fire_arrow",ground_detect:1b', 'max_damage': -1, 'rc': False, 'lc': False, 'other': ['tooltip_display={hidden_components:["enchantments","attribute_modifiers","unbreakable"]}', 'tooltip_style="epic"']}
#skill    = {'is_skill': True, 'cd': 0, 'name': ['符文陣 - 神聖之火', '#e6e6e6', '#aaaaaa'], 'info': ['箭矢命中地板或目標可以生成該符文的符文陣', '可以讓 4 格範圍內玩家持續獲得該符文持續 5 秒']}
#ultimate    = {'is_ultimate': False, 'name': ['狂風暴雨', 'dark_aqua', '#e6e6e6'], 'info': ['右鍵點擊消耗一個終焉之眼，', '接下來的8秒內如果在空中手持此武器擊中敵人', '在目標位置降下降下閃電造成5點傷害。']}
