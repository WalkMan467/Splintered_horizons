...
# "weapon.starry_sky_frost_arrow.type" : "箭矢 / 史詩"
# "weapon.starry_sky_frost_arrow.story.1" : "擁有符文力量的箭矢，"
# "weapon.starry_sky_frost_arrow.story.2" : "命中地板或目標可以生成該符文的符文陣"
# "weapon.starry_sky_frost_arrow.skill" : "[符文陣 - 星空之霜]"
# "weapon.starry_sky_frost_arrow.skill.1" : "箭矢命中地板或目標可以生成該符文的符文陣"
# "weapon.starry_sky_frost_arrow.skill.2" : "可以讓 4 格範圍內玩家持續獲得該符文持續 5 秒"

#name = ['星空之霜 - 符文箭矢', '#5de7ff', '箭矢 / 史詩']
#story = {'info': ['擁有符文力量的箭矢，', '命中地板或目標可以生成該符文的符文陣'], 'color': 'blue'}
#item_data     = {'real_item': 'arrow', 'id': 'starry_sky_frost_arrow', 'item_model': '"arrow/starry_sky_frost_arrow"', 'custom_data': 'type:"arrow",rarity:"epic",id:"starry_sky_frost_arrow",ground_detect:1b', 'max_damage': -1, 'rc': False, 'lc': False, 'other': ['tooltip_display={hidden_components:["enchantments","attribute_modifiers","unbreakable"]}', 'tooltip_style="epic"']}
#skill    = {'is_skill': True, 'cd': 0, 'name': ['符文陣 - 星空之霜', '#5de7ff', '#277cb4'], 'info': ['箭矢命中地板或目標可以生成該符文的符文陣', '可以讓 4 格範圍內玩家持續獲得該符文持續 5 秒']}
#ultimate    = {'is_ultimate': False, 'name': ['狂風暴雨', 'dark_aqua', '#5de7ff'], 'info': ['右鍵點擊消耗一個終焉之眼，', '接下來的8秒內如果在空中手持此武器擊中敵人', '在目標位置降下降下閃電造成5點傷害。']}
