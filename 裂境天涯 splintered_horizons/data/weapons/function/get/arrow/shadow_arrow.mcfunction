...
# "weapon.shadow_arrow.type" : "箭矢 / 史詩"
# "weapon.shadow_arrow.story.1" : "擁有符文力量的箭矢，"
# "weapon.shadow_arrow.story.2" : "命中地板或目標可以生成該符文的符文陣"
# "weapon.shadow_arrow.skill" : "[符文陣 - 至深之暗] "
# "weapon.shadow_arrow.skill.1" : "箭矢命中地板或目標可以生成該符文的符文陣"
# "weapon.shadow_arrow.skill.2" : "可以讓 4 格範圍內玩家持續獲得該符文持續 5 秒"

#name = ['至深之暗 - 符文箭矢', '#9e0096', '箭矢 / 史詩']
#story = {'info': ['擁有符文力量的箭矢，', '命中地板或目標可以生成該符文的符文陣'], 'color': 'blue'}
#item_data     = {'real_item': 'arrow', 'id': 'shadow_arrow', 'item_model': '"arrow/shadow_arrow"', 'custom_data': 'type:"arrow",rarity:"epic",id:"shadow_arrow",ground_detect:1b', 'max_damage': -1, 'rc': False, 'lc': False, 'other': ['tooltip_display={hidden_components:["enchantments","attribute_modifiers","unbreakable"]}', 'tooltip_style="epic"']}
#skill    = {'is_skill': True, 'cd': 0, 'name': ['符文陣 - 至深之暗', '#9e0096', '#8900fa'], 'info': ['箭矢命中地板或目標可以生成該符文的符文陣', '可以讓 4 格範圍內玩家持續獲得該符文持續 5 秒']}
#ultimate    = {'is_ultimate': False, 'name': ['狂風暴雨', 'dark_aqua', '#9e0096'], 'info': ['右鍵點擊消耗一個終焉之眼，', '接下來的8秒內如果在空中手持此武器擊中敵人', '在目標位置降下降下閃電造成5點傷害 ']}
