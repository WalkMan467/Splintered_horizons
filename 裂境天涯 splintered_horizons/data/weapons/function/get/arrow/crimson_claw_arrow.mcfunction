...
#item_data     = {'real_item': 'arrow', 'id': 'crimson_claw_arrow', 'item_model': '"arrow/crimson_claw_arrow"', 'custom_data': '{type:"arrow",rarity:"epic",id:"crimson_claw_arrow",ground_detect:1b}', 'max_damage': -1, 'rc': False, 'other': ['tooltip_display={hidden_components:["enchantments","attribute_modifiers","unbreakable"]}', 'tooltip_style="epic"']}
