...
# "weapon.resplendence_arrow.type" : "箭矢 / 史詩"
# "weapon.resplendence_arrow.story.1" : "擁有符文力量的箭矢，"
# "weapon.resplendence_arrow.story.2" : "命中地板或目標可以生成該符文的符文陣"
# "weapon.resplendence_arrow.skill" : "[符文陣 - 輝煌之光] "
# "weapon.resplendence_arrow.skill.1" : "箭矢命中地板或目標可以生成該符文的符文陣"
# "weapon.resplendence_arrow.skill.2" : "可以讓 4 格範圍內玩家持續獲得該符文持續 5 秒"

#name = ['輝煌之光 - 符文箭矢', '#fceb00', '箭矢 / 史詩']
#story = {'info': ['擁有符文力量的箭矢，', '命中地板或目標可以生成該符文的符文陣'], 'color': 'blue'}
#item_data     = {'real_item': 'arrow', 'id': 'resplendence_arrow', 'item_model': '"arrow/resplendence_arrow"', 'custom_data': 'type:"arrow",rarity:"epic",id:"resplendence_arrow",ground_detect:1b', 'max_damage': -1, 'rc': False, 'lc': False, 'other': ['tooltip_display={hidden_components:["enchantments","attribute_modifiers","unbreakable"]}', 'tooltip_style="epic"']}
#skill    = {'is_skill': True, 'cd': 0, 'name': ['符文陣 - 輝煌之光', '#fceb00', '#fff89a'], 'info': ['箭矢命中地板或目標可以生成該符文的符文陣', '可以讓 4 格範圍內玩家持續獲得該符文持續 5 秒']}
