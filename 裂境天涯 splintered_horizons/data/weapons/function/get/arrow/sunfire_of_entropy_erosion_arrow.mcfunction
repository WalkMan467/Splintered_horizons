...
# Translate Keys
# ==============================
# "weapon.sunfire_of_entropy_erosion_arrow" : "熵蝕之火箭矢",
# "weapon.sunfire_of_entropy_erosion_arrow.type" : "箭矢 / 傳說",
# "weapon.sunfire_of_entropy_erosion_arrow.story.1" : "古老的混沌之火壟罩了太陽",
# "weapon.sunfire_of_entropy_erosion_arrow.story.2" : "他們說這叫日蝕",
# "weapon.sunfire_of_entropy_erosion_arrow.story.3" : "但直到大陸上的火焰漸漸燃燒它們能燃燒的一切時",
# "weapon.sunfire_of_entropy_erosion_arrow.story.4" : "真正的日蝕，其實是一股名叫「熵」與「深淵」結合而成的",
# "weapon.sunfire_of_entropy_erosion_arrow.story.5" : "其力量來自於伊索克拉與梅倫絲娜的舊世界",
