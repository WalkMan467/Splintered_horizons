...
#story = {'info': ['天空中掉落的星星', '能夠透過鍛造台鍛造出強力的武器'], 'color': 'blue'}
#item_data = {'real_item': 'music_disc_11', 'id': 'moonlight_star', 'item_model': '"material/moonlight_star"', 'custom_data': '{rc:0b,type:"item",id:"moonlight_star"}', 'max_damage': -1, 'max_stack_size': 64, 'rc': False, 'other': ['tooltip_display={hidden_components:["attribute_modifiers","unbreakable","jukebox_playable"]}', 'tooltip_style="epic"']}
