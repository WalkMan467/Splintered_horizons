...
#story = {'info': ['吸收風之力量的粉塵', '能夠透過鍛造台鍛造出強力的武器'], 'color': 'blue'}
#item_data = {'real_item': 'music_disc_11', 'id': 'dust_of_the_wind', 'item_model': '"material/dust_of_the_wind"', 'custom_data': '{rc:0b,type:"item",id:"dust_of_the_wind"}', 'max_damage': -1, 'max_stack_size': 64, 'rc': False, 'other': ['tooltip_display={hidden_components:["attribute_modifiers","unbreakable","jukebox_playable"]}', 'tooltip_style="rare"']}
