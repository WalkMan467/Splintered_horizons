...
execute if score #in_safe_zone.ml global.main matches 0 run function items:type/tp_book/rc/safe_zone/load_pos
function items:type/tp_book/rc/safe_zone/save_pos

execute in minecraft:overworld if score #in_safe_zone.ml global.main matches 0 run function items:type/tp_book/rc/safe_zone/tp with storage item.tp_book.point temp
