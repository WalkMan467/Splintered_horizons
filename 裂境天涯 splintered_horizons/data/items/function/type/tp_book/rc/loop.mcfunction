...
execute as @a[scores={item.tp_book.casting=0}] at @s if score @s item.tp_book.point.area matches 2 run function items:type/tp_book/rc/safe_zone/in
execute as @a[scores={item.tp_book.casting=0}] at @s if score @s item.tp_book.point.area matches 1 run function items:type/tp_book/rc/safe_zone/out
