...
execute \
    if score @s bossfight.attack_module.timeline matches 19 run \
    return run \
function bossfight:chapter_2/elekiel_phase_2/attack_module/state/attack2/particle/combo1/0/use

execute \
    if score @s bossfight.attack_module.timeline matches 20 run \
    return run \
function bossfight:chapter_2/elekiel_phase_2/attack_module/state/attack2/particle/combo1/1/use

execute \
    if score @s bossfight.attack_module.timeline matches 21 run \
    return run \
function bossfight:chapter_2/elekiel_phase_2/attack_module/state/attack2/particle/combo1/2/use

execute \
    if score @s bossfight.attack_module.timeline matches 22 run \
    return run \
function bossfight:chapter_2/elekiel_phase_2/attack_module/state/attack2/particle/combo1/3/use

execute \
    if score @s bossfight.attack_module.timeline matches 28 run \
    return run \
data modify entity @s NoGravity set value false

execute \
    unless score @s bossfight.attack_module.timeline matches 28.. run \
return 0
