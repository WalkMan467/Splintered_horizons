...
function bossfight:chapter_2/elekiel_phase_2/skills/1/mysterray/2
...
function bossfight:chapter_2/elekiel_phase_2/skills/1/mysterray/slime/main
...
function bossfight:chapter_2/elekiel_phase_2/skills/1/death_tips
...
damage @s 8 bossfight:chapter_2/elekiel_phase_2/skills/1/mysterray/dmg by @n[sort=arbitrary,distance=0..,tag=monsters.elekiel_phase_2,type=skeleton]
