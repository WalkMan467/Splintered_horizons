...
function bossfight:chapter_2/elekiel_phase_2/skills/1/main
...
function bossfight:chapter_2/elekiel_phase_2/skills/2/main
...
function bossfight:chapter_2/elekiel_phase_2/skills/3/main
...
function bossfight:chapter_2/elekiel_phase_2/skills/4/main
...
function bossfight:chapter_2/elekiel_phase_2/skills/5/main

# Monster Self

execute \
    as @n[sort=arbitrary,distance=0..,tag=monsters.elekiel_phase_2,type=skeleton] at @s run \
function bossfight:chapter_2/elekiel_phase_2/skills/main.monster

# Players

execute \
    as @a at @s run \
function bossfight:chapter_2/elekiel_phase_2/skills/player/main
