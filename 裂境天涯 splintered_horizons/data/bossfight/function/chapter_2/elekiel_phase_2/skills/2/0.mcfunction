...
function bossfight:chapter_2/elekiel_phase_2/skills/2/1
...
tag @a[scores={monster.elekiel_phase_2.skill.4.effect.void=1..}] remove temp
...
function bossfight:chapter_2/elekiel_phase_2/skills/2/cage/use
