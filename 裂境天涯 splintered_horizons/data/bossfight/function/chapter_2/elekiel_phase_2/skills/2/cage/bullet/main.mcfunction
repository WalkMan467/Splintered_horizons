...
execute at @s run \
function bossfight:chapter_2/elekiel_phase_2/skills/2/cage/bullet/2
...
function bossfight:chapter_2/elekiel_phase_2/skills/2/cage/bullet/3

# Damage

execute \
    if entity @a[tag=sys.victim,limit=1] run \
function bossfight:chapter_2/elekiel_phase_2/skills/2/cage/bullet/hit


execute \
    if score @s mob.duration matches 100.. run \
function bossfight:chapter_2/elekiel_phase_2/skills/2/cage/bullet/clear