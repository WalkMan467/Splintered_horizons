...
function bossfight:chapter_2/elekiel_phase_2/skills/4/portal/crack/main

execute \
    as @e[sort=arbitrary,tag=mob.elekiel.2.crack_silhouette,distance=0..,type=text_display] at @s run \
function bossfight:chapter_2/elekiel_phase_2/skills/4/portal/crack_silhouette/main

execute \
    as @e[sort=arbitrary,tag=mob.elekiel.2.digit,distance=0..,type=text_display] at @s run \
function bossfight:chapter_2/elekiel_phase_2/skills/4/portal/digit/main
