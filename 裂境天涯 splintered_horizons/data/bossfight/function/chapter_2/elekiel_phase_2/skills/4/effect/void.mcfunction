...
item replace entity @s armor.chest with poisonous_potato[equippable={slot:"chest",asset_id:"air"},item_model="air",tooltip_display={hide_tooltip:true},enchantment_glint_override=false,enchantments={"binding_curse":1,"bossfight:chapter_2/elekiel_phase_2/skills/4/damage_immunity":1}] 1
