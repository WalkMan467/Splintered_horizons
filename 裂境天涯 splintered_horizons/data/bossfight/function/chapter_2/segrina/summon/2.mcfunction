...
summon zombie 762 107 642 {NoAI:1b,Health:400.0f,Silent:1b,Rotation:[0.0f,0.0f],DeathLootTable:"-",PersistenceRequired:1b,Tags:["freeze.immunity","segrina","monster","monsters.segrina"],Passengers:[{id:"minecraft:marker",Tags:["monster.marker"],data:{Death:"bossfight:chapter_2/segrina/skills"}}],CustomName:{"bold":false,"color":"gold","fallback":"永劫輪迴的墮落者「阿斯尼亞」","italic":false,"translate":"monsters.segrina"},equipment:{feet:{id:"minecraft:barrier",count:1},legs:{id:"minecraft:leather_leggings",count:1,components:{enchantments:{"armors:creeper_explosion_immunity":1},enchantment_glint_override:false,tooltip_display:{hidden_components:["trim"]},equippable:{slot:"legs",asset_id:"air"}}},chest:{id:"minecraft:leather_chestplate",count:1,components:{enchantments:{"armors:resilient":2},enchantment_glint_override:false,unbreakable:{},tooltip_display:{hidden_components:["trim"]},equippable:{slot:"chest",asset_id:"air"}}},head:{id:"minecraft:stone_button",count:1,components:{item_model:"air",equippable:{slot:"head",asset_id:"air"}}},mainhand:{id:"minecraft:wooden_axe",count:1,components:{attribute_modifiers:[{id:"attack_damage",type:"attack_damage",amount:0.0,operation:"add_multiplied_base",slot:"mainhand"}],item_model:"air"}},offhand:{id:"minecraft:barrier",count:1}},drop_chances:{feet:0.000,legs:0.000,chest:0.000,head:0.000,mainhand:0.000,offhand:0.000},active_effects:[{id:"minecraft:invisibility",amplifier:255,duration:-1,show_particles:0b,show_icon:0b,ambient:0b}],attributes:[{id:"minecraft:armor",base:8},{id:"minecraft:armor_toughness",base:3},{id:"minecraft:attack_damage",base:0},{id:"minecraft:follow_range",base:1024},{id:"minecraft:max_health",base:400},{id:"minecraft:movement_speed",base:0.27},{id:"minecraft:safe_fall_distance",base:1024},{id:"minecraft:scale",base:1}]}
