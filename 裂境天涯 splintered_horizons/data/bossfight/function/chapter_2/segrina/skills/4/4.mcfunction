...
execute \
    unless score @s monster.segrina.skill.4.invincible matches -2147483648..2147483647 run \
...
function bossfight:chapter_2/segrina/skills/4/bossbar/summon with storage monster.segrina.skill.4.invincible temp
