...
function bossfight:chapter_2/segrina/skills/1/3 with entity 002fa81f-0034-3432-fff9-b5670000a0fd data.pos

execute \
    if score #monster.segrina.1.ball.dark global.main matches 1.. run \
function bossfight:chapter_2/segrina/skills/1/4 with entity 002fa81f-0034-3432-fff9-b5670000a0fd data.pos