...
execute \
    ...
    as @a run \
function bossfight:chapter_2/elekiel/skills/2/vampire_flower/target

execute \
    as @e[distance=0..,tag=monsters.elekiel.2.vampire_flower.timer,tag=monsters.elekiel.2.vampire_flower.state.1,type=text_display] at @s \
    if score @s monster.elekiel.2.timer matches 0 run \
function bossfight:chapter_2/elekiel/skills/2/vampire_flower/flower
...
function bossfight:chapter_2/elekiel/skills/2/vampire_flower/run