...
name = ['破厄之冠', '#810092', '頭盔']
story = {'info': ['來自舊世界的裝備，', '有著強大的力量，', '會使裝備者受到負面增益時，','另外獲得強大的增益。'], 'color': 'blue'}
item_data     = {'real_item': 'leather_helmet', 'id': 'banebreaker_crown', 'item_model': '""', 'custom_data': '{banebreaker:1b,type:"armor"}', 'max_damage': -1}
