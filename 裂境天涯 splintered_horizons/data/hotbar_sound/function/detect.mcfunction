...
execute if items entity @s weapon.mainhand * unless item entity @s weapon.mainhand #minecraft:tool unless item entity @s weapon.mainhand #minecraft:swords run playsound minecraft:block.note_block.hat voice @a ~ ~1 ~ 0.5 1