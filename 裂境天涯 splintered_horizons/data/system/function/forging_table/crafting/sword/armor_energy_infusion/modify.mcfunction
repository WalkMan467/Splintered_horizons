...
$item modify entity @s container.0 {function:"minecraft:set_enchantments",enchantments:$(enchantments),add:1b}
...
tag @s remove system.forging_table.crafted_item.energy_infusion.target