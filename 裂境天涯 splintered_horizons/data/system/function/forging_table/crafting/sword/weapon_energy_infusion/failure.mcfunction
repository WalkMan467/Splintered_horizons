tag @s add system.forging_table.crafted_item.energy_infusion.failure

scoreboard players set @a[distance=..6] player.actionbar.system.forging_table.energy_infusion_failure 40
