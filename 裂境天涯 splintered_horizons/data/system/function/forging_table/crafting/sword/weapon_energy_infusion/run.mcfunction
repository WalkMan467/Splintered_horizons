execute if entity @s[tag=!system.forging_table.crafted_item.energy_infusion.failure] at @s run function system:forging_table/crafting/sword/weapon_energy_infusion/failure
