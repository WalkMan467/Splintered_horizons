tp @n[type=item,nbt={Item:{components: {"minecraft:custom_data": {monument:1b}}}}] @p
data modify entity @n[type=item,nbt={Item:{components: {"minecraft:custom_data": {monument:1b}}}}] PickupDelay set value 0
