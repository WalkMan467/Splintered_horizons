tp @n[type=item,nbt={Item:{components: {"minecraft:custom_data": {monument:2b}}}}] @p
data modify entity @n[type=item,nbt={Item:{components: {"minecraft:custom_data": {monument:2b}}}}] PickupDelay set value 0
