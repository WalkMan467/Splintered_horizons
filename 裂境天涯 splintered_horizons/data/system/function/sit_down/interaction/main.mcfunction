execute as @s[tag=system.sit_down.act,tag=!active] if entity @p[distance=..2.5] run function system:sit_down/interaction/view/1
...
execute as @s[tag=system.sit_down.act,tag=active] unless entity @p[distance=..2.5] run function system:sit_down/interaction/view/0
