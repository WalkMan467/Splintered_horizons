...
execute if score #story:icon/proper_noun/great_old_ones global.main matches 1.. run advancement grant @a only story:icon/proper_noun/great_old_ones
execute unless score #story:icon/proper_noun/great_old_ones global.main matches 1.. run advancement revoke @a only story:icon/proper_noun/great_old_ones

execute if score #story:icon/proper_noun/runes global.main matches 1.. run advancement grant @a only story:icon/proper_noun/runes
execute unless score #story:icon/proper_noun/runes global.main matches 1.. run advancement revoke @a only story:icon/proper_noun/runes
...
execute if score #story:icon/story/chapter_1/sq/1/title global.main matches 1.. run advancement grant @a only story:icon/story/chapter_1/sq/1/title
execute unless score #story:icon/story/chapter_1/sq/1/title global.main matches 1.. run advancement revoke @a only story:icon/story/chapter_1/sq/1/title

execute if score #story:icon/story/chapter_1/sq/1/1 global.main matches 1.. run advancement grant @a only story:icon/story/chapter_1/sq/1/1
execute unless score #story:icon/story/chapter_1/sq/1/1 global.main matches 1.. run advancement revoke @a only story:icon/story/chapter_1/sq/1/1

execute if score #story:icon/story/chapter_1/sq/1/2 global.main matches 1.. run advancement grant @a only story:icon/story/chapter_1/sq/1/2
execute unless score #story:icon/story/chapter_1/sq/1/2 global.main matches 1.. run advancement revoke @a only story:icon/story/chapter_1/sq/1/2
...
execute if score #story:icon/character/selena/icon global.main matches 1.. run advancement grant @a only story:icon/character/selena/icon
execute unless score #story:icon/character/selena/icon global.main matches 1.. run advancement revoke @a only story:icon/character/selena/icon

execute if score #story:icon/character/selena/story_1 global.main matches 1.. run advancement grant @a only story:icon/character/selena/story_1
execute unless score #story:icon/character/selena/story_1 global.main matches 1.. run advancement revoke @a only story:icon/character/selena/story_1

execute if score #story:icon/character/selena/story_1_1 global.main matches 1.. run advancement grant @a only story:icon/character/selena/story_1_1
execute unless score #story:icon/character/selena/story_1_1 global.main matches 1.. run advancement revoke @a only story:icon/character/selena/story_1_1

execute if score #story:icon/character/selena/story_1_2 global.main matches 1.. run advancement grant @a only story:icon/character/selena/story_1_2
execute unless score #story:icon/character/selena/story_1_2 global.main matches 1.. run advancement revoke @a only story:icon/character/selena/story_1_2

execute if score #story:icon/character/selena/story_1_3 global.main matches 1.. run advancement grant @a only story:icon/character/selena/story_1_3
execute unless score #story:icon/character/selena/story_1_3 global.main matches 1.. run advancement revoke @a only story:icon/character/selena/story_1_3

execute if score #story:icon/character/selena/story_1_4 global.main matches 1.. run advancement grant @a only story:icon/character/selena/story_1_4
execute unless score #story:icon/character/selena/story_1_4 global.main matches 1.. run advancement revoke @a only story:icon/character/selena/story_1_4

execute if score #story:icon/character/selena/story_1_5 global.main matches 1.. run advancement grant @a only story:icon/character/selena/story_1_5
execute unless score #story:icon/character/selena/story_1_5 global.main matches 1.. run advancement revoke @a only story:icon/character/selena/story_1_5

execute if score #story:icon/character/selena/story_1_6 global.main matches 1.. run advancement grant @a only story:icon/character/selena/story_1_6
execute unless score #story:icon/character/selena/story_1_6 global.main matches 1.. run advancement revoke @a only story:icon/character/selena/story_1_6
