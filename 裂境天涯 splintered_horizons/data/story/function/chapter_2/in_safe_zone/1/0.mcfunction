...
execute as @a run scoreboard players operation @s item.tp_book.point.x = @s item.tp_book.point.x.temp
execute as @a run scoreboard players operation @s item.tp_book.point.y = @s item.tp_book.point.y.temp
execute as @a run scoreboard players operation @s item.tp_book.point.z = @s item.tp_book.point.z.temp
execute as @a run scoreboard players set @s item.tp_book.point.area 2
