...
execute if score story.chapter_2.ml story.chapter_2 matches 540..720 run title @a actionbar {"translate": "story.chapter_2.ml.4","fallback": "［守衛1］我勸你們別冒然靠近這裡"}
execute if score story.chapter_2.ml story.chapter_2 matches 720..900 run title @a actionbar {"translate": "story.chapter_2.ml.5","fallback": "［守衛2］警戒，對方雖然只有兩個人"}
execute if score story.chapter_2.ml story.chapter_2 matches 900..1080 run title @a actionbar {"translate": "story.chapter_2.ml.6","fallback": "［守衛2］各位小心，我有股感覺... 他們並非常人"}
execute if score story.chapter_2.ml story.chapter_2 matches 1080..1260 run title @a actionbar {"translate": "story.chapter_2.ml.7","fallback": "［守衛3］深淵的爪牙居然會保護擁有世界樹力量的男孩？"}
