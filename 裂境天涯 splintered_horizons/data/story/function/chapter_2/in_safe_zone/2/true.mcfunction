...
execute positioned 762 146 991 as @e[type=item_display,tag=aj.sophia.root,distance=..1] at @s run function animated_java:sophia/remove/this
...
summon interaction 764.0 146 992.0 {width:4,height:2.5,UUID:[I; 12, 21, 24, 25],Tags:["story.chapter_2.in_safe_zone.2","story.chapter_2.in_safe_zone.2.act","interaction.sound.default"]}

execute positioned 762 146 991 as @e[type=item_display,tag=aj.sophia.root,distance=..1] at @s run function animated_java:sophia/remove/this
execute positioned 762 146 991 rotated -71.56503 0.0 run function animated_java:sophia/summon {args: {animation: 'idle', start_animation: true}}
