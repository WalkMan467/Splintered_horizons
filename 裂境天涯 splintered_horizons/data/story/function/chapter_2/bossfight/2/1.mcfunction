...
execute if score story.chapter_2.bossfight.ml story.chapter_2 matches 2 run tellraw @a {"translate": "story.chapter_2.bossfight.ml.2","fallback": "［拉爾西斯］但即便如此為什麼仍像我揮劍"}
