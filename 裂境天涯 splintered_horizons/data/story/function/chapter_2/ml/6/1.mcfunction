...
tellraw @a[distance=..16] \
    [ \
        {"translate": "story.characters.selina",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.2","fallback": "如同二位看到到其他英傑，作為「記憶之冰」符文使者，我擁有讀取世界記憶的能力","bold": false} \
    ]
...
tellraw @a[distance=..16] \
    [ \
        ...
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.3","fallback": "但我希望你能跟大家好好相處","bold": false} \
    ]
...
tellraw @a[distance=..16] \
    [ \
        ...
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.4","fallback": "沒事的，我不會在意","bold": false} \
    ]
...
tellraw @a[distance=..16] \
    [ \
        ...
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.5","fallback": "我也是","bold": false} \
    ]
...
tellraw @a[distance=..16] \
    [ \
        ...
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.6","fallback": "梅倫絲娜，或許你根本不理解深淵對我帶來的痛苦","bold": false} \
    ]
...
tellraw @a[distance=..16] \
    [ \
        ...
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.7","fallback": "我即是哈薩諾爾的王儲，但我...連哈薩諾爾都無法守護","bold": false} \
    ]
...
tellraw @a[distance=..16] \
    [ \
        ...
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.10","fallback": "你也知道，這些深淵怪物並不是憑空出現的","bold": false} \
    ]
...
tellraw @a[distance=..16] \
    [ \
        ...
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.11","fallback": "而是每個被侵蝕的人們最終的結局","bold": false} \
    ]
...
tellraw @a[distance=..16] \
    [ \
        ...
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.12","fallback": "甚至連我們終究都無法擺脫命運","bold": false} \
    ]
...
tellraw @a[distance=..16] \
    [ \
        ...
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.14","fallback": "哥哥，我很抱歉","bold": false} \
    ]
...
tellraw @a[distance=..16] \
    [ \
        ...
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.15","fallback": "如果可以，我想與你一同即便深淵","bold": false,"with":[{"bold":true,"color":"dark_red","hover_event":{"action":"show_text","value":[{"translate":"story.icon.proper_noun","fallback":"[專有名詞]:","color":"white"},"\n",{"translate": "proper_noun.desc.2","fallback":"詳情請按","color":"white","bold":false,"italic":false},{"keybind": "key.advancements","color": "dark_green"},{"translate": "proper_noun.desc.3","fallback":"尋找對應內容","color":"white","bold":false,"italic":false}]},"italic":false,"translate":"story.icon.proper_noun.finality","underlined":true,"fallback": "終焉"}]} \
    ]
...
tellraw @a[distance=..16] \
    [ \
        ...
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.16","fallback": "與你一同見證沒有深淵的世界","bold": false,"with":[{"bold":true,"color":"dark_red","hover_event":{"action":"show_text","value":[{"translate":"story.icon.proper_noun","fallback":"[專有名詞]:","color":"white"},"\n",{"translate": "proper_noun.desc.2","fallback":"詳情請按","color":"white","bold":false,"italic":false},{"keybind": "key.advancements","color": "dark_green"},{"translate": "proper_noun.desc.3","fallback":"尋找對應內容","color":"white","bold":false,"italic":false}]},"italic":false,"translate":"story.icon.proper_noun.finality","underlined":true,"fallback": "終焉"}]} \
    ]
...
tellraw @a[distance=..16] \
    [ \
        ...
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
        {"text":" : ","color":"white","bold": false}, \
        {"translate": "story.chapter_2.ml.6.17","fallback": "但願一切能夠好起來","bold": false} \
    ]
...
execute \
    unless score story.chapter_2.ml.6 story.chapter_2 matches 1..18 run \
return 0
