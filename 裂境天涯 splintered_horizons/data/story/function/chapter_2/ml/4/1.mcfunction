...
execute \
    if score story.chapter_2.ml.4 story.chapter_2 matches 1 run \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 2 run \
tellraw @a[distance=..16] \
    [ \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 3 run \
tellraw @a[distance=..16] \
    [ \
        {"translate": "stoy.characters.melisna",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 4 run \
tellraw @a[distance=..16] \
    [ \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 5 run \
tellraw @a[distance=..16] \
    [ \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 6 run \
tellraw @a[distance=..16] \
    [ \
        {"translate": "stoy.characters.isokla",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 7 run \
tellraw @a[distance=..16] \
    [ \
        {"translate": "stoy.characters.isokla",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 8 run \
tellraw @a[distance=..16] \
    [ \
        {"translate": "stoy.characters.isokla",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 9 run \
tellraw @a[distance=..16] \
    [ \
        {"translate": "stoy.characters.isokla",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 10 run \
tellraw @a[distance=..16] \
    [ \
        {"translate": "stoy.characters.isokla",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 11 run \
tellraw @a[distance=..16] \
    [ \
        {"translate": "stoy.characters.isokla",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 12 run \
tellraw @a[distance=..16] \
    [ \
        {"translate": "stoy.characters.isokla",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 13 run \
tellraw @a[distance=..16] \
    [ \
        {"translate": "stoy.characters.isokla",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 14 run \
tellraw @a[distance=..16] \
    [ \
        {"translate": "stoy.characters.melisna",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 15 run \
tellraw @a[distance=..16] \
    [ \
        {"translate": "stoy.characters.melisna",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
...
execute \
    positioned 928 167 908 \
    if score story.chapter_2.ml.4 story.chapter_2 matches 16 run \
tellraw @a[distance=..16] \
    [ \
        {"translate": "stoy.characters.melisna",color:"white","bold":true}, \
        {"player":{"properties":[{"name":"textures","value":""}]},"bold":false}, \
...
execute \
    unless score story.chapter_2.ml.4 story.chapter_2 matches 1..18 run \
return 0
