...
execute as @n[tag=aj.sophia.root,limit=1,type=item_display] run function animated_java:sophia/remove/this


execute positioned 926.50 167.2 907.75 rotated 0 0 run function animated_java:sophia/summon {args:{}}
execute positioned 926.50 167.2 907.75 unless score #story:icon/story/chapter_2/scebe_2 global.main matches 1 as @n[type=item_display,tag=aj.sophia.root,distance=..3] on passengers run data modify entity @s Glowing set value 1b
...
execute as @n[tag=aj.sophia.root,limit=1,type=item_display] run function animated_java:sophia/animations/sit_down/play
