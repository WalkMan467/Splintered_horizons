...
execute as 00000019-0000-0015-0000-003300000005 at @s if data entity @s interaction.timestamp if score story.chapter_2.campfire.2 story.chapter_2 matches 1..5 run function story:chapter_2/campfire/2/1
