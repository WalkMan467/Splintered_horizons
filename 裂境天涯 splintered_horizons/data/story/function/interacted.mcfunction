...
execute as 00000002-0000-0139-0000-00370000000b at @s if data entity @s interaction.timestamp if score story.chapter_1.campfire.1.3 story.chapter_1 matches 1..28 run function story:chapter_1/opening/3/1
execute as 00000019-0000-0015-0000-003300000005 at @s if data entity @s interaction.timestamp if score story.chapter_2.campfire.2 story.chapter_2 matches 1..4 run function story:chapter_2/campfire/2/1
...
execute as 00000019-0000-0015-0000-003300000033 at @s if data entity @s interaction.timestamp if score story.chapter_2.campfire.1 story.chapter_2 matches 1..16 run function story:chapter_2/campfire/3/1
