...
execute as 00000001-0000-0015-0000-003300000005 at @s if data entity @s interaction.timestamp if score story.chapter_1.ml.1 story.chapter_1 matches 1..44 run function story:chapter_1/ml/1/1
execute as 00000002-0000-0139-0000-00370000000b at @s if data entity @s interaction.timestamp if score story.chapter_1.ml.3 story.chapter_1 matches 1..28 run function story:chapter_1/ml/3/1
execute as 00000016-0000-0139-0000-00370000000b at @s if data entity @s interaction.timestamp if score story.chapter_1.ml.2 story.chapter_1 matches 1..28 run function story:chapter_1/ml/2/1
execute as 00000002-0000-0139-0000-003700000033 at @s if data entity @s interaction.timestamp if score story.chapter_1.ml.4 story.chapter_1 matches 1..5 run function story:chapter_1/ml/4/1
