...
execute positioned 287 182 -187 unless score #story:icon/story/chapter_1/mq/scebe_3 global.main matches 1 as @n[type=item_display,tag=aj.rainy_night.root,distance=..3] on passengers run data modify entity @s Glowing set value 1b
