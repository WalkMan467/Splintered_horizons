...
execute positioned 287 182 -187 if score story.chapter_1.campfire.3 story.chapter_1 matches 1 unless score #story:icon/story/chapter_2/scebe_1 global.main matches 1 as @n[type=item_display,tag=aj.rainy_night.root,distance=..3] on passengers run data modify entity @s Glowing set value 0b
execute if score story.chapter_1.campfire.3 story.chapter_1 matches 1 run scoreboard players set #story:icon/story/chapter_2/scebe_1 global.main 1
