...
execute positioned 38 64 9 if score story.chapter_1.campfire.1 story.chapter_1 matches 14 run tellraw @a[distance=..16] [{"translate": "story.chapter_1.campfire.1.14","fallback": "[你] 這個世界曾發生過一場慘烈的戰爭 "},{"bold":true,"color":"gold","hover_event":{"action":"show_text","value":[{"translate":"story.icon.proper_noun","fallback":"[專有名詞]:","color":"white"},"\n",{"translate": "proper_noun.desc.2","fallback":"詳情請按","color":"white","bold":false,"italic":false},{"keybind": "key.advancements","color": "dark_green"},{"translate": "proper_noun.desc.3","fallback":"尋找對應內容","color":"white","bold":false,"italic":false}]},"italic":false,"translate":"story.icon.proper_noun.war_of_light_and_darkness","underlined":true}]
