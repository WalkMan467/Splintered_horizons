scoreboard players set #story.chapter_1.ml.2_temp global.main 1
...
execute positioned 1 64 -109 unless score #story:icon/story/chapter_1/scebe_2 global.main matches 1 \
...
summon interaction 1 64 -109 \
    { \
        Tags:["story.chapter_1.ml.2.act","interaction.sound.default"], \
        height:2, \
        UUID:[I; 22, 313, 55, 11] \
    }
