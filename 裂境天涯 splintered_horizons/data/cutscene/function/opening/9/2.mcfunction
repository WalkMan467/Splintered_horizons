...
function animated_java:kyle/summon {args: {animation: 'cutscene_attack_1', start_animation: true}}

execute \
    positioned 9999 93 10066 \
    as @e[sort=arbitrary,tag=aj.kyle.root,distance=..1,type=item_display] run \
function animated_java:kyle/animations/cutscene_attack_1/set_frame {frame:40}
