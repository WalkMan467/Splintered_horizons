...
execute if score @s armor.symbiotic_blood_oath.cd matches 1.. run return 0
...
execute rotated ~ 0 run function armors:type/symbiotic_blood_oath/fx

tag @s add armor.symbiotic_blood_oath.user

execute store result storage temp symbiotic_blood_oath.player.health float 0.25 run scoreboard players get @s player.health

execute if entity @p[sort=arbitrary,distance=..6,tag=!armor.symbiotic_blood_oath.user] run function armors:type/symbiotic_blood_oath/multiple_players/true with storage temp symbiotic_blood_oath.player
execute unless entity @p[sort=arbitrary,distance=..6,tag=!armor.symbiotic_blood_oath.user] run function armors:type/symbiotic_blood_oath/multiple_players/false with storage temp symbiotic_blood_oath.player
