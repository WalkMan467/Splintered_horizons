...
execute unless score @s player.animation.lock matches 1.. unless predicate armors:type/black_hole/boots/sneak if score @s armor.black_hole.boots.sneak matches 1..3 run function armors:type/black_hole/animation/boots/play
