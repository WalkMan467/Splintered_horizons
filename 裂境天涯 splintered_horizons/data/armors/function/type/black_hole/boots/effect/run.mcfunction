...
execute if score @s armor.black_hole.boots.damage_delay matches 0 run damage @s[type=!player,type=!#minecraft:dummy_mob] 2 armors:type/black_hole/damage by @p
