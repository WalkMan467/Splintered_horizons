...
#             'custom_data': 'type:"armor",rarity:"epic",id:"wtsf"',
#             'rc': False,
#             'lc': False,
#             'max_damage': 0,
#             'max_stack_size': 1,
