...
scoreboard players remove @a[scores={armor.finality_chestplate.attack_increased=1..}] armor.finality_chestplate.attack_increased 1

execute as @a[scores={armor.finality_chestplate.attack_increased=1}] run attribute @s attack_damage modifier remove armor.finality_chestplate.effect
