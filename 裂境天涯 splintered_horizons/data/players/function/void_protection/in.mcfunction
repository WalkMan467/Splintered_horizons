...
execute \
    ...
    return run \
item modify entity @s armor.head {type:"minecraft:set_enchantments",enchantments:{"players:void_protection/void_immunity":1},add:false}

execute \
    if items entity @s armor.chest * run \
    return run \
item modify entity @s armor.chest {type:"minecraft:set_enchantments",enchantments:{"players:void_protection/void_immunity":1},add:false}

execute \
    if items entity @s armor.legs * run \
    return run \
item modify entity @s armor.legs {type:"minecraft:set_enchantments",enchantments:{"players:void_protection/void_immunity":1},add:false}

execute \
    if items entity @s armor.feet * run \
    return run \
item modify entity @s armor.feet {type:"minecraft:set_enchantments",enchantments:{"players:void_protection/void_immunity":1},add:false}
