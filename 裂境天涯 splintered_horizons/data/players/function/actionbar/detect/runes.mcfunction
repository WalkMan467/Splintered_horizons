...
execute if score @s player.actionbar.sys.forging_table.failure matches 1.. run return 0
execute if score @s player.actionbar.disabled_bed matches 1.. run return 0
execute if score @s player.actionbar.disabled_anvil matches 1.. run return 0
