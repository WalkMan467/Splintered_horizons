...
function main:map_lobby/interacted
...
function system:tree_of_world_memory/interacted
function system:interacted
function players:tombstone_system/act/interacted