...
execute \
    unless score @s player.detect.death matches 1.. run \
return 0
...
title @s subtitle [{"translate":"tips.player_death.3","color":"white"},{"text":": "},{"score":{name:"@s",objective:"player.death_count"},"color":"white"}]

execute \
    if score @s player.death_count matches 60..80 run \
title @s subtitle [{"translate":"tips.player_death.3","color":"white"},{"text":": "},{"score":{name:"@s",objective:"player.death_count"},"color":"yellow"}]

execute \
    if score @s player.death_count matches 80..100 run \
title @s subtitle [{"translate":"tips.player_death.3","color":"white"},{"text":": "},{"score":{name:"@s",objective:"player.death_count"},"color":"gold"}]

execute \
    if score @s player.death_count matches 100..120 run \
title @s subtitle [{"translate":"tips.player_death.3","color":"white"},{"text":": "},{"score":{name:"@s",objective:"player.death_count"},"color":"red"}]
