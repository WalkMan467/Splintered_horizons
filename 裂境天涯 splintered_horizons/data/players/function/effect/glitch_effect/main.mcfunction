...
execute \
    if score @s player.effect.glitch_effect matches 75 run \
title @s title {"text": "\uE031","shadow_color":0,"color": "white", "font": "minecraft:screen"}

execute \
    if score @s player.effect.glitch_effect matches 76..100 run \
title @s title {"text": "\uE000","shadow_color":0,"color": "white", "font": "minecraft:screen"}
...
execute \
    if score @s player.effect.glitch_effect matches 100.. run \
