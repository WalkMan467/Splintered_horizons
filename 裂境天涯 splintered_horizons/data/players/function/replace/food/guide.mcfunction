tag @s remove player.replace.food
playsound minecraft:entity.item.pickup voice @s ~ ~1 ~ 0.5 0.75

scoreboard players set #player.replace.food.temp global.main 0



execute \
    if items entity @s container.1 #foods run \
item replace entity @s weapon.mainhand from entity @s container.1

execute \
    if items entity @s container.1 #foods run \
scoreboard players set #player.replace.food.temp global.main 1
...
execute \
    if score #player.replace.food.temp global.main matches 1 run \
return 0



execute \
    if items entity @s container.2 #foods run \
...
execute \
    if items entity @s container.3 #foods run \
...
execute \
    if items entity @s container.4 #foods run \
...
execute \
    if items entity @s container.5 #foods run \
...
execute \
    if items entity @s container.6 #foods run \
...
execute \
    if items entity @s container.7 #foods run \
...
execute \
    if items entity @s container.8 #foods run \
...
execute \
    if items entity @s container.9 #foods run \
...
execute \
    if items entity @s container.10 #foods run \
...
execute \
    if items entity @s container.11 #foods run \
...
execute \
    if items entity @s container.12 #foods run \
...
execute \
    if items entity @s container.13 #foods run \
...
execute \
    if items entity @s container.14 #foods run \
...
execute \
    if items entity @s container.15 #foods run \
...
execute \
    if items entity @s container.16 #foods run \
...
execute \
    if items entity @s container.17 #foods run \
...
execute \
    if items entity @s container.18 #foods run \
...
execute \
    if items entity @s container.19 #foods run \
...
execute \
    if items entity @s container.20 #foods run \
...
execute \
    if items entity @s container.21 #foods run \
...
execute \
    if items entity @s container.22 #foods run \
...
execute \
    if items entity @s container.23 #foods run \
...
execute \
    if items entity @s container.24 #foods run \
...
execute \
    if items entity @s container.25 #foods run \
...
execute \
    if items entity @s container.26 #foods run \
...
execute \
    if items entity @s container.27 #foods run \
...
execute \
    if items entity @s container.28 #foods run \
...
execute \
    if items entity @s container.29 #foods run \
...
execute \
    if items entity @s container.30 #foods run \
...
execute \
    if items entity @s container.31 #foods run \
...
execute \
    if items entity @s container.32 #foods run \
...
execute \
    if items entity @s container.33 #foods run \
...
execute \
    if items entity @s container.34 #foods run \
...
execute \
    if items entity @s container.35 #foods run \
