tag @s remove player.replace.torch
playsound minecraft:entity.item.pickup voice @s ~ ~1 ~ 0.5 0.75

scoreboard players set #player.replace.torch.temp global.main 0



execute \
    if items entity @s container.1 #torchs run \
item replace entity @s weapon.mainhand from entity @s container.1

execute \
    if items entity @s container.1 #torchs run \
scoreboard players set #player.replace.torch.temp global.main 1
...
execute \
    if items entity @s container.3 #torchs run \
...
execute \
    if items entity @s container.4 #torchs run \
...
execute \
    if items entity @s container.5 #torchs run \
...
execute \
    if items entity @s container.6 #torchs run \
...
execute \
    if items entity @s container.7 #torchs run \
...
execute \
    if items entity @s container.8 #torchs run \
...
execute \
    if items entity @s container.9 #torchs run \
...
execute \
    if items entity @s container.10 #torchs run \
...
execute \
    if items entity @s container.11 #torchs run \
...
execute \
    if items entity @s container.12 #torchs run \
...
execute \
    if items entity @s container.13 #torchs run \
...
execute \
    if items entity @s container.14 #torchs run \
...
execute \
    if items entity @s container.15 #torchs run \
...
execute \
    if items entity @s container.16 #torchs run \
...
execute \
    if items entity @s container.17 #torchs run \
...
execute \
    if items entity @s container.18 #torchs run \
...
execute \
    if items entity @s container.19 #torchs run \
...
execute \
    if items entity @s container.20 #torchs run \
...
execute \
    if items entity @s container.21 #torchs run \
...
execute \
    if items entity @s container.22 #torchs run \
...
execute \
    if items entity @s container.23 #torchs run \
...
execute \
    if items entity @s container.24 #torchs run \
...
execute \
    if items entity @s container.25 #torchs run \
...
execute \
    if items entity @s container.26 #torchs run \
...
execute \
    if items entity @s container.27 #torchs run \
...
execute \
    if items entity @s container.28 #torchs run \
...
execute \
    if items entity @s container.29 #torchs run \
...
execute \
    if items entity @s container.30 #torchs run \
...
execute \
    if items entity @s container.31 #torchs run \
...
execute \
    if items entity @s container.32 #torchs run \
...
execute \
    if items entity @s container.33 #torchs run \
...
execute \
    if items entity @s container.34 #torchs run \
...
execute \
    if items entity @s container.35 #torchs run \
