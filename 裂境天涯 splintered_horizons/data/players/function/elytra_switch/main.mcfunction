...
execute unless score @s player.disable.elytra_switch matches 1.. if score @s player.detect.air matches 10.. if biome ~ ~ ~ world_area:main/safe_zone run advancement grant @s only players:elytra_switch/true
