execute if items entity @s[tag=player.elytra_switch] player.cursor *[custom_data~{disable_drop:1b}] run function players:elytra_switch/reset_2
execute if items entity @s[tag=player.elytra_switch] player.cursor *[custom_data~{disable_drop:1b}] run item replace entity @s player.cursor with air
execute unless items entity @s[tag=player.elytra_switch] weapon.offhand *[custom_data~{elytra_switch:1b}] run item replace entity @s weapon.offhand with firework_rocket[tooltip_display={hide_tooltip:true},custom_data={elytra_switch:1b,disable_drop:1b},fireworks={flight_duration:1}] 1
...
execute if entity @s[tag=!player.elytra_switch] run clear @s *[custom_data~{disable_drop:1b}]
