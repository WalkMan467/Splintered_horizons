...
execute if score #in_safe_zone.ml global.main matches 1 run scoreboard players operation @s item.tp_book.point.z = @s item.tp_book.point.z.temp
execute if score #in_safe_zone.ml global.main matches 1 run scoreboard players set @s item.tp_book.point.area 1
