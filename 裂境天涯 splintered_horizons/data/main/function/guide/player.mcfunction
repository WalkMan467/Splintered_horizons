...
execute \
    as @e[distance=..15,sort=nearest,limit=5,tag=sys.campfire,type=interaction] at @s run \
function sys:campfire/interaction/main
...
execute \
    if score @s player.hide matches 1 run \
