...
#story = {'info': ['散發光輝的鐵錠', '能鍛造出強大的武器與裝備'], 'color': 'blue'}
#item_data = {'real_item': 'music_disc_11', 'id': 'holy_light_iron_ingot', 'item_model': '"material/holy_light_iron_ingot"', 'custom_data': '{rc:0b,type:"item",id:"holy_light_iron_ingot"}', 'max_damage': -1, 'max_stack_size': 64, 'rc': False, 'other': ['tooltip_display={hidden_components:["attribute_modifiers","unbreakable","jukebox_playable"]}', 'tooltip_style="epic"']}
