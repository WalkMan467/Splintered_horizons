...
# "item.rockbound_crystal.story.1" : "吸收岩之力量的晶體"
# "item.rockbound_crystal.story.2" : "能夠透過鍛造台鍛造出強力的武器"

#name = ['盤岩晶體', '#e4a42f', '鍛造材料 / 史詩']
#story = {'info': ['吸收岩之力量的晶體', '能夠透過鍛造台鍛造出強力的武器'], 'color': 'blue'}
#item_data = {'real_item': 'music_disc_11', 'id': 'rockbound_crystal', 'item_model': '"material/rockbound_crystal"', 'custom_data': '{rc:0b,type:"item",id:"rockbound_crystal"}', 'max_damage': -1, 'max_stack_size': 64, 'rc': False, 'other': ['tooltip_display={hidden_components:["attribute_modifiers","unbreakable","jukebox_playable"]}', 'tooltip_style="epic"']}
