...
story = {'info': ['被終焉之力侵蝕的合金錠', '擁有遠超鎢鋼的硬度','四周散發極不穩定的終焉力量與輻射能量','能鍛造出非常強大的武器與裝備'], 'color': 'blue'}
item_data = {'real_item': 'music_disc_11', 'id': 'finality_ingot', 'item_model': '"material/finality_ingot"', 'custom_data': '{rc:0b,type:"item",id:"finality_ingot"}', 'max_damage': -1, 'max_stack_size': 64, 'rc': False, 'lc': False, 'other': ['tooltip_display={hidden_components:["attribute_modifiers","unbreakable","jukebox_playable"]}', 'tooltip_style="mythic"']}
