...
execute if entity @s[tag=item.tp_book.save.temp] run function item:type/tp_book/rc/safe_zone/save_pos
execute if entity @s[tag=item.tp_book.save.temp] run function item:type/tp_book/rc/safe_zone/load_pos
execute if entity @s[tag=item.tp_book.save.temp] run tag @s remove item.tp_book.save.temp


execute unless entity @s[tag=item.tp_book.save.temp] run function item:type/tp_book/rc/safe_zone/load_pos
execute unless entity @s[tag=item.tp_book.save.temp] run function item:type/tp_book/rc/safe_zone/save_pos

execute in minecraft:overworld run function item:type/tp_book/rc/safe_zone/tp with storage item.tp_book.point temp
