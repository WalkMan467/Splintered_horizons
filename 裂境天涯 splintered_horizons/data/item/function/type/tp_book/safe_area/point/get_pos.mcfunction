...
execute store result storage temp tp_book.point.x int 0.001 run \
scoreboard players get @s item.tp_book.point.x.temp

execute store result storage temp tp_book.point.y int 0.001 run \
scoreboard players get @s item.tp_book.point.y.temp

execute store result storage temp tp_book.point.z int 0.001 run \
