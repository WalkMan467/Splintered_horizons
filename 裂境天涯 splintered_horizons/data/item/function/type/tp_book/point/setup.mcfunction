...
execute store result score @s item.tp_book.point.x run data get entity @s Pos[0] 1000
execute store result score @s item.tp_book.point.y run data get entity @s Pos[1] 1000
execute store result score @s item.tp_book.point.z run data get entity @s Pos[2] 1000
