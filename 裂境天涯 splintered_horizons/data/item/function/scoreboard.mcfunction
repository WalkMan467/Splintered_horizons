...
scoreboard objectives add item.tp_book.point.x.temp dummy "傳送書記錄點 x temp"
scoreboard objectives add item.tp_book.point.y.temp dummy "傳送書記錄點 y temp"
scoreboard objectives add item.tp_book.point.z.temp dummy "傳送書記錄點 z temp"
