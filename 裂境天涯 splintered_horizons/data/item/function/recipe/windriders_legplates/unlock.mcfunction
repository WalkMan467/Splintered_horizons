advancement revoke @s only item:recipe/windriders_legplates


execute \
    if score #sys.forging_table.windriders_legplates sys.forging_table.recipes matches 1.. run \
return 0
clear @s *[custom_data~{type:"recipe",id:"windriders_legplates"}]
...
tellraw @a [{"translate": "sys.forging_table.unlock.1","color":"white","bold": false},{"translate":"armor.windriders_legplates","color":"#00ff80","bold": true},{"translate":"sys.forging_table.unlock.2","color":"white","bold": false}]


tellraw @a [{"text":"\n"}]

tellraw @a [{"translate":"armor.windriders_legplates","color":"#00ff80","italic":false,"bold":true}]
