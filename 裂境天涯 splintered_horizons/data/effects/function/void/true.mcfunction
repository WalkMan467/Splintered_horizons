...
attribute @s movement_speed modifier add effect.void -0.75 add_multiplied_base
attribute @s jump_strength modifier add effect.void -0.5 add_multiplied_base
